...
/**
 * Parses loop settings and creates MN_Query according to manual
 * @since 4.2
 * @link http://codex.wordpress.org/Class_Reference/MN_Query
 */
class VcLoopQueryBuilder {
	...
	public function build() {
		return array( $this->args, new MN_Query( $this->args ) );
	}
}
 ...
 */
class VcLoopSettings {
	// Available parts of loop for MN_Query object.
	/**
	 * @since 4.2
	 * @var array
	 */
...
/**
 * Suggestion list for mn_query field
...
/**
 * Build MN_Query object from query string.
...
add_action( 'mn_ajax_wpb_get_loop_suggestion', 'vc_get_loop_suggestion' );
add_action( 'mn_ajax_wpb_get_loop_settings', 'vc_get_loop_settings_json' );
