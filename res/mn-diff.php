<?php
/**
 * Mtaandao Diff bastard child of old MediaWiki Diff Formatter.
 *
 ...
 */
class MN_Text_Diff_Renderer_Table extends Text_Diff_Renderer {
	 ...
	 * @since 2.6.0
	 */
	protected $inline_diff_renderer = 'MN_Text_Diff_Renderer_inline';
	...
	public function _deleted( $lines, $encode = true ) {
		...
		foreach ($lines as $line) {
			if ( $encode ) {
				...
				/** This filter is documented in res/mn-diff.php */
 ...
 */
class MN_Text_Diff_Renderer_inline extends Text_Diff_Renderer_inline {
