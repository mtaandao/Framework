	...
	public static function popup() {
		...
		// Cache not found
			...
			$tools = apply_filters( 'su/generator/tools', array(
					...
					'<a href="http://mtaandao.co.ke/support/plugin/shortcodes-ultimate/" target="_blank" title="' . __( 'Support forums', 'shortcodes-ultimate' ) . '">' . __( 'Support forums', 'shortcodes-ultimate' ) . '</a>'
				) );
