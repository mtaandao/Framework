...
class RWMB_Autocomplete_Field extends RWMB_Multiple_Values_Field {
	...
	static function admin_enqueue_scripts() {
		mn_enqueue_style( 'rwmb-autocomplete', RWMB_CSS_URL . 'autocomplete.css', array( 'mn-admin' ), RWMB_VER );
		mn_enqueue_script( 'rwmb-autocomplete', RWMB_JS_URL . 'autocomplete.js', array( 'jquery-ui-autocomplete' ), RWMB_VER, true );
	...
	static function html( $meta, $field ) {
		...
		if ( ! is_string( $field['options'] ) ) {
			...
			$options = mn_json_encode( $options );
		}
