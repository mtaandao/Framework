...
Redux is a simple, truly extensible and fully responsive options framework for Mtaandao themes and plugins. Ships with an integrated demo.

== Description ==

Redux is a simple, truly extensible and fully responsive options framework for Mtaandao themes and plugins. Built on the Mtaandao Settings API, Redux supports a multitude of field types as well as custom error handling, custom field & validation types, and import/export functionality.
...
[**http://demo.reduxframework.com/admin/**](http://demo.reduxframework.com/admin/)
...
* Color (Mtaandao Native)
* Color Gradient
* Color RGBA
* Date
* Dimensions (Height/Width)
* Divide (Divider)
* Editor (Mtaandao Native)
* Gallery (Mtaandao Native)
* Image Select (Patterns/Presets)
* Import/Export
* Info (Header/Notice)
* Link Color
* Media (Mtaandao Native)
* Multi-Text
* Password
* Radio (w/ Mtaandao Data)
* Raw (HTML/PHP/MarkDown)
* Section (Indent and Group Fields)
* Select (Select/Multi-Select w/ Select2 & Mtaandao Data)
* Select Image
...
We need your help to translate Redux into your language! Redux is part of the mn-Translations.org team. To help us translate Redux create a few account here: <a href="https://www.transifex.com/organization/mn-translations">https://www.transifex.com/organization/mn-translations</a>. Once you're in, you can head over to the <a href="https://www.transifex.com/projects/p/redux-framework/">Redux sub-project</a> and translate away. Thank you for your assistance.
...
* Modified: #1658 - Improvements from @shivapoudel, including:
  * Removed makepot and used grunt-mn-i18n instead.
...
* Modified:   How we declare the uploads directory and URL. Using core mn functions now.
...
= 3.3.4.8 =
* Fixed:      More mn FileSystem tanking. Did PHP fallback before FTP. Works 99.9% of the time without credentials.
...
= 3.3.4 =
* Fixed:      Issues with file writing. Basically many users don't install Mtaandao with all the permissions
...
* Added:      #1427 - button_set added to customizer UI.  Thanks @mnexplorer.
* Fixed:      #1429 - ACE Editor erroring with no default value set.
* Fixed:      mn_filesystem now initialized with credentials in an effort to combat the tmp file issue.
...
* Fixed:      Redux uploads dir should NOT be ~/main/uploads, but just main. As per Otto.
...
* Modified:   Google CSS moved into HEAD via mn enqueue.
...
* Fixed:        Style conflicts with mn 3.9. Added register filter to fields via id.
...
* Fixed:      Reset section, etc. Discovered an odd Mtaandao thing.
...
* Fixed:      mn 3.9 update made editor field button look ugly.
...
* Fixed:      Fully compatible with Mtaandao 3.9. Now it just works.  ;)
...
* Modified:   removed add_submenu_page when creating a submenu for us in the mn admin area.  mn approved API is used in it's place to being Redux up to mn.org theme check standards.
...
* Modified:   Removed Google font CSS line from header (because it's in the footer via mn_enqueue_style.
...
* Fixed:    mn_content_dir path now handles double forward slashes.
...
* Removed:  mn_get_current_user check.  See https://github.com/ReduxFramework/ReduxFramework/wiki/How-to-fix-%22Fatal-error%3A-Call-to-undefined-function-mn_get_current_user%28%29-%22
...
* Fixed Sortable - Using native jQuery UI library same as within Mtaandao.
...
* Fix in how Mtaandao data is received, improved some output.
...
* Fixed admin https error with Mtaandao core not renaming URL.
...
* Removed get_theme_data() fallbacks, we're well pass Mtaandao 3.4 now.  ;)
...
* Issue 285 - HTTPS errors on admin. Known Mtaandao bug. Resolved.
...
* Feature - Make is to the mn dir can be moved elsewhere and Redux still function.
...
* Fixed issue #132 (See #134, thanks @andreilupu): Could not have multiple Mtaandao Editors (mn_editor) as the same ID was shared. Also fixed various styles to match Mtaandao for this field.
...
= 3.0.0 =
* Initial Mtaandao.org plugin release.

= 3.0 =
Redux is now hosted on Mtaandao.org! Update in order to get proper, stable updates.
