...
/**
 * Bulk Plugin Upgrader Skin for Mtaandao Plugin Upgrades.
 *
 * @since 3.0.0
...
class Bulk_Plugin_Upgrader_Skin extends Bulk_Upgrader_Skin {
	...
	public function bulk_footer() {
		...
		$update_actions =  array(
			...
			'updates_page' => '<a href="' . self_admin_url( 'update-core.php' ) . '" target="_parent">' . __( 'Return to Mtaandao Updates page' ) . '</a>'
		);
