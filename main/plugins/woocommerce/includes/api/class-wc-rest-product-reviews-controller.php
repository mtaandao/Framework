...
class WC_REST_Product_Reviews_Controller extends WC_REST_Controller {
	...
	public function get_items( $request ) {
		...
		if ( empty( $product->post_type ) || 'product' !== $product->post_type ) {
			return new MN_Error( 'woocommerce_rest_product_invalid_id', __( 'Invalid product id.', 'woocommerce' ), array( 'status' => 404 ) );
		}
	 ...
	 *
	 * @param MN_Comment $review Product review object.
	...
	public function prepare_item_for_response( $review, $request ) {
		 ...
		 * @param MN_Comment       $review   Product review object used to create response.
		 * @param MN_REST_Request  $request  Request object.
		 */
