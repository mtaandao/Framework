...
class Vc_Navbar_Frontend extends Vc_Navbar {
	 ...
	 * @var string
	 */
	protected $brand_url = 'http://vc.mtaandao.co.ke/plugins/page-builder/?utm_campaign=VCplugin&utm_source=vc_user&utm_medium=frontend_editor';
	...
	public function getControlSaveUpdate() {
		...
		<li class="vc_show-mobile vc_pull-right">
			<button data-url="<?php esc_attr_e( get_edit_post_link( $post->ID ) . '&wpb_vc_js_status=true' ) ?>"
			        ...
			        title="<?php _e( 'Cancel all changes and return to MN dashboard', 'js_composer' ) ?>"><?php echo vc_user_access()
					->part( 'backend_editor' )
					->can()
