...
class RWMB_Datetime_Field extends RWMB_Text_Field {
	...
	public static function admin_register_scripts() {
		...
		mn_register_style( 'jquery-ui-core', "$url/jquery.ui.core.css", array(), '1.8.17' );
		mn_register_style( 'jquery-ui-theme', "$url/jquery.ui.theme.css", array(), '1.8.17' );
		mn_register_style( 'mn-datepicker', RWMB_CSS_URL . 'datepicker.css', array( 'jquery-ui-core', 'jquery-ui-theme' ), '1.8.17' );
		mn_register_style( 'jquery-ui-datepicker', "$url/jquery.ui.datepicker.css", array( 'mn-datepicker' ), '1.8.17' );
		mn_register_style( 'jquery-ui-slider', "$url/jquery.ui.slider.css", array( 'jquery-ui-core', 'jquery-ui-theme' ), '1.8.17' );
		mn_register_style( 'jquery-ui-timepicker', "$url/jquery-ui-timepicker-addon.min.css", array( 'jquery-ui-datepicker', 'jquery-ui-slider', 'mn-datepicker' ), '1.5.0' );

		$url = RWMB_JS_URL . 'jqueryui';
		mn_register_script( 'jquery-ui-datepicker-i18n', "$url/jquery-ui-i18n.min.js", array( 'jquery-ui-datepicker' ), '1.11.4', true );
		mn_register_script( 'jquery-ui-timepicker', "$url/jquery-ui-timepicker-addon.min.js", array( 'jquery-ui-datepicker', 'jquery-ui-slider' ), '1.5.0', true );
		mn_register_script( 'jquery-ui-timepicker-i18n', "$url/jquery-ui-timepicker-addon-i18n.min.js", array( 'jquery-ui-timepicker' ), '1.5.0', true );

		mn_register_script( 'rwmb-datetime', RWMB_JS_URL . 'datetime.js', array( 'jquery-ui-datepicker-i18n', 'jquery-ui-timepicker-i18n' ), RWMB_VER, true );
		mn_register_script( 'rwmb-date', RWMB_JS_URL . 'date.js', array( 'jquery-ui-datepicker-i18n', 'jquery-ui-timepicker-i18n' ), RWMB_VER, true );
		mn_register_script( 'rwmb-time', RWMB_JS_URL . 'time.js', array( 'jquery-ui-timepicker-i18n' ), RWMB_VER, true );
	...
	public static function admin_enqueue_scripts() {
		...
		mn_enqueue_style( 'jquery-ui-timepicker' );
		mn_enqueue_script( 'rwmb-datetime' );
	}
	...
	public static function html( $meta, $field ) {
		...
		if ( $field['timestamp'] ) {
			...
			$field = mn_parse_args( array( 'field_name' => $name . '[formatted]' ), $field );
			$output .= sprintf(
