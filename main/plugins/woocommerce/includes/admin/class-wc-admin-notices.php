...
class WC_Admin_Notices {
	...
	public static function init() {
		...
		add_action( 'mn_loaded', array( __CLASS__, 'hide_notices' ) );
	...
	public static function hide_notices() {
		if ( isset( $_GET['wc-hide-notice'] ) && isset( $_GET['_wc_notice_nonce'] ) ) {
			if ( ! mn_verify_nonce( $_GET['_wc_notice_nonce'], 'woocommerce_hide_notices_nonce' ) ) {
	...
	public static function add_notices() {
		...
		if ( ! empty( $notices ) ) {
			mn_enqueue_style( 'woocommerce-activation', plugins_url(  '/assets/css/activation.css', WC_PLUGIN_FILE ) );
	...
	public static function add_custom_notice( $name, $notice_html ) {
		...
		update_option( 'woocommerce_admin_notice_' . $name, mn_kses_post( $notice_html ) );
	}
	...
	public static function no_shipping_methods_notice() {
		if ( wc_shipping_enabled() && ( empty( $_GET['page'] ) || empty( $_GET['tab'] ) || 'wc-settings' !== $_GET['page'] || 'shipping' !== $_GET['tab'] ) ) {
			...
			$product_count = mn_count_posts( 'product' );
