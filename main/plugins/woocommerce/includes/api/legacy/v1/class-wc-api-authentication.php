...
class WC_API_Authentication {
	...
	public function __construct() {
		...
		// To disable authentication, hook into this filter at a later priority and return a valid MN_User
	...
	public function authenticate( $user ) {
		...
		try {
			...
			$user = new MN_Error( 'woocommerce_api_authentication_error', $e->getMessage(), array( 'status' => $e->getCode() ) );
		}
	...
	private function get_keys_by_consumer_key( $consumer_key ) {
		...
		$keys = $mndb->get_row( $mndb->prepare( "
