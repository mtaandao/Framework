...
class RWMB_Input_List_Field extends RWMB_Choice_Field {
	...
	public static function admin_enqueue_scripts() {
		mn_enqueue_style( 'rwmb-input-list', RWMB_CSS_URL . 'input-list.css', array(), RWMB_VER );
		mn_enqueue_script( 'rwmb-input-list', RWMB_JS_URL . 'input-list.js', array(), RWMB_VER, true );
	}
