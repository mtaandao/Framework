...
/**
 * Translation Upgrader Skin for Mtaandao Translation Upgrades.
 *
 * @since 3.7.0
 ...
 */
class Language_Pack_Upgrader_Skin extends MN_Upgrader_Skin {
	...
	public function bulk_footer() {
		...
		$update_actions['updates_page'] = '<a href="' . self_admin_url( 'update-core.php' ) . '" target="_parent">' . __( 'Return to Mtaandao Updates page' ) . '</a>';
