...
class RWMB_File_Upload_Field extends RWMB_Media_Field {
	...
	public static function admin_enqueue_scripts() {
		...
		mn_enqueue_style( 'rwmb-upload', RWMB_CSS_URL . 'upload.css', array( 'rwmb-media' ), RWMB_VER );
		mn_enqueue_script( 'rwmb-file-upload', RWMB_JS_URL . 'file-upload.js', array( 'rwmb-media' ), RWMB_VER, true );
	}
