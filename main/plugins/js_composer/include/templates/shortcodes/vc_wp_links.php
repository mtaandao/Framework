 ...
 * @var $el_class
 * Shortcode class
 * @var $this WPBakeryShortCode_VC_mn_Links
 */
...
$output = '<div class="vc_mn_links wpb_content_element' . esc_attr( $el_class ) . '">';
$type = 'MN_Widget_Links';
$args = array();
...
if ( is_object( $mn_widget_factory ) && isset( $mn_widget_factory->widgets, $mn_widget_factory->widgets[ $type ] ) ) {
	...
	echo $this->debugComment( 'Widget ' . esc_attr( $type ) . 'Not found in : vc_mn_links' );
}
