 ...
 * @version     2.3.0
 */
class WC_Tax_Rate_Importer extends MN_Importer {
	...
	public function greet() {
		...
		if ( ! empty( $upload_dir['error'] ) ) :
			...
			?>
			<form enctype="multipart/form-data" id="import-upload-form" method="post" action="<?php echo esc_attr(mn_nonce_url($action, 'import-upload')); ?>">
