...
class WC_CLI_Report extends WC_CLI_Command {
	 ...
	 *     mn wc report sales
	 *
	 *     mn wc report sales --period=last_month
	 *
	 * @since 2.5.0
	 */
	 ...
	 * ## EXAMPLES
	 *
	 *     mn wc report top_sellers
	 *
	 *     mn wc report top_sellers --period=last_month
	 *
	 * @since 2.5.0
	 */
	public function top_sellers( $__, $assoc_args ) {
		...
		if ( 'ids' === $formatter->format ) {
			...
			echo implode( ' ', mn_list_pluck( $top_sellers_data, 'product_id' ) );
		} else {
