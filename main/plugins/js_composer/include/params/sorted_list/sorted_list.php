...
class Vc_Teaser_Box {
	...
	public function outputTeaser() {
		mn_enqueue_script( 'wpb_jscomposer_teaser_js' );
		mn_localize_script( 'wpb_jscomposer_teaser_js', 'i18nVcTeaser', array(
		...
		$output .= '<img src="' . get_site_url() . '/admin/images/mnspin_light.gif" /></div>';
