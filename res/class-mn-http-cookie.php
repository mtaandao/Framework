 ...
 * already a MN_Http_Cookie() object, then they are turned into one.
 *
 * @todo The Mtaandao convention is to use underscores instead of camelCase for function and method
 * names. Need to switch to use underscores instead for the methods.
 *
 * @since 2.8.0
 */
class MN_Http_Cookie {
	...
	public function getHeaderValue() {
		 ...
		 */
		return $this->name . '=' . apply_filters( 'mn_http_cookie_value', $this->value, $this->name );
	}

	/**
	 * Retrieve cookie header for usage in the rest of the Mtaandao HTTP API.
	 *
	 * @access public
	 * @since 2.8.0
	 *
