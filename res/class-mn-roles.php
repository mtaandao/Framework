...
class MN_Roles {
	 ...
	 *
	 * The role key is set to the current prefix for the $mndb object with
	 * 'user_roles' appended. If the $mn_user_roles global is set, then it will
	 ...
	 * @return MN_Role|void MN_Role object, if role is added.
	 */
	public function add_role( $role, $display_name, $capabilities = array() ) {
		...
		$this->role_objects[$role] = new MN_Role( $role, $capabilities );
