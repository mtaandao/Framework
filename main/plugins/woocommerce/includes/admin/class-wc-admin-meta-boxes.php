...
class WC_Admin_Meta_Boxes {
	...
	public function save_meta_boxes( $post_id, $post ) {
		...
		if ( defined( 'DOING_AUTOSAVE' ) || is_int( mn_is_post_revision( $post ) ) || is_int( mn_is_post_autosave( $post ) ) ) {
			return;
		}

		// Check the nonce
		if ( empty( $_POST['woocommerce_meta_nonce'] ) || ! mn_verify_nonce( $_POST['woocommerce_meta_nonce'], 'woocommerce_save_data' ) ) {
			return;
		}
