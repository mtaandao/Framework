/* global _mnWidgetCustomizerPreviewSettings */
mn.customize.widgetsPreview = mn.customize.WidgetCustomizerPreview = (function( $, _, mn, api ) {
	...
	self.SidebarPartial = api.selectiveRefresh.Partial.extend({
		 ...
		 * @since 4.5.0
		 *
		 * @return {Array.<mn.customize.selectiveRefresh.Placement>} List of placements that were reflowed.
		 */
		 ...
		 * @returns {mn.customize.selectiveRefresh.Partial} Widget instance partial.
		 */
	...
	api.bind( 'preview-ready', function() {
		$.extend( self, _mnWidgetCustomizerPreviewSettings );
		self.init();
	});
