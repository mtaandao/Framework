 ...
 * @return object|array|MN_Error|null Category data in type defined by $output parameter.
 *                                    MN_Error if $category is empty, null if it does not exist.
 */
 ...
 *
 * It is also possible that it will return a MN_Error object on failure. Check
 ...
 * @param string $output Optional. Constant OBJECT, ARRAY_A, or ARRAY_N
 * @return object|array|MN_Error|void Type is based on $output value.
 */
...
function get_cat_name( $cat_id ) {
	...
	if ( ! $category || is_mn_error( $category ) )
		return '';
 ...
 * @param string $output Optional. Constant OBJECT, ARRAY_A, or ARRAY_N
 * @param string $filter Optional. Default is raw or no Mtaandao defined filter will applied.
 * @return object|array|MN_Error|null Tag data in type defined by $output parameter. MN_Error if $tag is empty, null if it does not exist.
 */
 ...
 *
 * @since 2.3.0
 * @since 4.4.0 The `$category` parameter now also accepts a MN_Term object.
 * @access private
 *
 * @param array|object|MN_Term $category Category Row object or array
 */
function _make_cat_compat( &$category ) {
	if ( is_object( $category ) && ! is_mn_error( $category ) ) {
