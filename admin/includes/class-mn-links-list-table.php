<?php
/**
 * List Table API: MN_Links_List_Table class
 *
 * @package Mtaandao
 ...
 * @see MN_List_Tsble
 */
class MN_Links_List_Table extends MN_List_Table {
	...
	public function prepare_items() {
		...
		mn_reset_vars( array( 'action', 'cat_id', 'link_id', 'orderby', 'order', 's' ) );
...
<?php
	...
	public function display_rows() {
		foreach ( $this->items as $link ) {
			...
			$link->link_category = mn_get_link_cats( $link->link_id );
?>
...
<?php
	...
	protected function handle_row_actions( $link, $column_name, $primary ) {
		...
		$actions['delete'] = "<a class='submitdelete' href='" . mn_nonce_url("link.php?action=delete&amp;link_id=$link->link_id", 'delete-bookmark_' . $link->link_id) . "' onclick=\"if ( confirm( '" . esc_js(sprintf(__("You are about to delete this link '%s'\n  'Cancel' to stop, 'OK' to delete."), $link->link_name)) . "' ) ) { return true;}return false;\">" . __('Delete') . "</a>";
