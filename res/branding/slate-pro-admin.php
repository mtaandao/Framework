...
function custom_branding_plugin_menu() {
	add_menu_page(
		...
		'custom_branding_color_schemes',
		plugins_url( 'images/custom_branding_plugin_icon.png', __FILE__ ),
		'98.2481'
	);
	add_submenu_page(
		'custom_branding_color_schemes',
...
function custom_branding_admin_enqueue( $page ) {
	...
	mn_enqueue_style( 'custom-branding-admin', plugins_url( 'css/custom_branding.css', __FILE__ ) );
	mn_enqueue_script( 'custom-branding', plugins_url( 'js/custom_branding.js', __FILE__ ), array( 'jquery' ), CUSTOM_BRANDING_VERSION );
	...
	if ( 'toplevel_page_custom_branding_color_schemes' === $page ) {
		...
		mn_enqueue_script( 'spectrum-js', plugins_url( 'js/spectrum.js', __FILE__ ), array( 'jquery' ), CUSTOM_BRANDING_VERSION );
	}
...
function custom_branding_admin_footer_text() {
	...
	if ( 'on' === $custom_branding_settings['footerTextShow'] ) {
		...
		$footerText = 'Admin Theme <a href="http://sevenbold.com/mtaandao/custom-branding/" target="_blank">Custom Branding</a> by <a href="http://sevenbold.com/mtaandao/" target="_blank">Seven Bold</a>';
	}
...
function custom_branding_activate() {
	...
	$default_option = array(
		...
		'loginLogoHide'               => '',
		'loginLogo'                   => plugins_url( '/images/custom_branding_login_logo.png', __FILE__ ),
		'loginBgImage'                => plugins_url( '/images/custom_branding_background.jpg', __FILE__ ),
		'loginBgPosition'             => 'center top',
		'loginBgRepeat'               => 'no-repeat',
		'loginBgFull'                 => 'on',
		// Admin Branding
		'adminLogo'                   => plugins_url( '/images/custom_branding_admin_logo.png', __FILE__ ),
		'adminLogoFolded'             => plugins_url( '/images/custom_branding_admin_logo_folded.png', __FILE__ ),
		'adminFavicon'                => plugins_url( '/images/custom_branding_favicon.png', __FILE__ ),
		// Admin Menu
		'adminMenu'                   => array(),
