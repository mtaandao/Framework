...
get_current_screen()->add_help_tab( array(
	...
	'<p>' . __( 'XFN stands for <a href="http://gmpg.org/xfn/" target="_blank">XHTML Friends Network</a>, which is optional. Mtaandao allows the generation of XFN attributes to show how you are related to the authors/owners of the site to which you are linking.' ) . '</p>'
) );

get_current_screen()->set_help_sidebar(
	'<p><strong>' . __( 'For more information:' ) . '</strong></p>' .
	'<p>' . __( '<a href="https://mtaandao.co.ke/docs/Links_Add_New_Screen" target="_blank">Documentation on Creating Links</a>' ) . '</p>' .
...
<div class="inside">
	...
	<p><?php _e('Example: <code>http://mtaandao.co.ke/</code> &#8212; don&#8217;t forget the <code>http://</code>'); ?></p>
</div>
</div>
