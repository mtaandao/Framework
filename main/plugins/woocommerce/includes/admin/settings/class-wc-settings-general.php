	...
	public function get_settings() {
		...
		$settings = apply_filters( 'woocommerce_general_settings', array(
			...
			array(
				...
				'desc_tip' =>  __( 'This option determines a customers default location. The MaxMind GeoLite Database will be periodically downloaded to your main directory if using geolocation.', 'woocommerce' ),
				'default'  => 'geolocation',
				'type'     => 'select',
				'class'    => 'wc-enhanced-select',
				'options'  => array(
