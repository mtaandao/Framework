 ...
 * @author   WooThemes
 */
class WC_CLI_Command extends MN_CLI_Command {

	/**
	 * Add common cli arguments to argument list before MN_Query is run.
	 *
	 * @since  2.5.0
	 ...
	 * @return array
	 */
	protected function merge_mn_query_args( $base_args, $assoc_args ) {
		$args = array();
	...
	/**
	 * Add common cli arguments to argument list before MN_User_Query is run.
	 *
	 * @since  2.5.0
	 * @param  array $base_args required arguments for the query (e.g. `post_type`, etc)
	 * @param  array $assoc_args arguments provided in when invoking the command
	 * @return array
	 */
	protected function merge_mn_user_query_args( $base_args, $assoc_args ) {
		$args = array();
	 ...
	 * @return \MN_CLI\Formatter
	 */
	protected function get_formatter( $assoc_args ) {
		$args = $this->get_format_args( $assoc_args );
		return new \MN_CLI\Formatter( $args );
	}
