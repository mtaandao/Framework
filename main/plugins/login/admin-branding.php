...
function custom_mn_login_load_custom_mn_admin_style() {
        ...
        // Custom CSS
        mn_register_style( 'wpbizplugins-admin-customization', plugins_url( '/assets/css/admin-customization.css', __FILE__ ), false, '1.0.0' );
        mn_enqueue_style( 'wpbizplugins-admin-customization' );
...
function custom_mn_login_change_dashboard_name_on_dashboard() {
    ...
    if( ( is_admin() ) && ( isset( $custom_mn_login_options[ 'dashboard_name'] ) ) && ( $custom_mn_login_options[ 'dashboard_name'] != '' ) ) {
        ...
        jQuery( "div#mnwrap div#mncontent div#wpbody div#wpbody-content div.wrap h2" ).text("' . $custom_mn_login_options[ 'dashboard_name'] . '");
    });</script>';
