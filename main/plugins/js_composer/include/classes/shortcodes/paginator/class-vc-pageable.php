...
abstract class WPBakeryShortCode_Vc_Pageable extends WPBakeryShortCode {
	...
	public function shortcodeScripts() {
		mn_register_script( 'vc_pageable_owl-carousel', vc_asset_url( 'lib/owl-carousel2-dist/owl.carousel.min.js' ), array(
			'jquery',
		), WPB_VC_VERSION, true );
		mn_register_script( 'waypoints', vc_asset_url( 'lib/waypoints/waypoints.min.js' ), array( 'jquery' ), WPB_VC_VERSION, true );

		mn_register_style( 'vc_pageable_owl-carousel-css', vc_asset_url( 'lib/owl-carousel2-dist/assets/owl.min.css' ), array(), WPB_VC_VERSION, false );
	}
	...
	public function enqueueScripts() {
		mn_enqueue_script( 'vc_pageable_owl-carousel' );
		mn_enqueue_style( 'vc_pageable_owl-carousel-css' );
		mn_enqueue_style( 'animate-css' );
	}
	...
	public function currentUserCanManage( $page_id ) {
		return vc_user_access()
			->mnAny( array( 'edit_post', (int) $page_id ) )
			->get();
	}
}
