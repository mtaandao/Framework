...
function vc_gitem_template_attribute_post_image( $data ) {
	...
	if ( 'attachment' === $post->post_type ) {
		return mn_get_attachment_image( $post->ID, 'large' );
	}
...
function vc_gitem_template_attribute_post_image_url( $data, $user_empty = true ) {
	...
	if ( 'attachment' === $post->post_type ) {
		$src = mn_get_attachment_image_src( $post->ID, 'large' );
	} else {
		$attachment_id = get_post_thumbnail_id( $post->ID );
		$src = mn_get_attachment_image_src( $attachment_id, 'large' );
	}
...
function vc_gitem_template_attribute_post_image_alt( $value, $data ) {
	...
	$alt = trim( strip_tags( get_post_meta( $attachment_id, '_mn_attachment_image_alt', true ) ) );
