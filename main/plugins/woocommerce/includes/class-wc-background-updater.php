 ...
 * Background Updater
 *
 * Uses https://github.com/A5hleyRich/mn-background-processing to handle DB
...
include_once( 'libraries/mn-async-request.php' );
include_once( 'libraries/mn-background-process.php' );

/**
 * WC_Background_Updater Class.
 */
class WC_Background_Updater extends MN_Background_Process {
	...
	protected function schedule_event() {
		if ( ! mn_next_scheduled( $this->cron_hook_identifier ) ) {
			mn_schedule_event( time() + 10, $this->cron_interval_identifier, $this->cron_hook_identifier );
		}
	}
