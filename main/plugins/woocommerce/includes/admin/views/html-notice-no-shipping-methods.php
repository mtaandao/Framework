...
<div id="message" class="updated woocommerce-message woocommerce-no-shipping-methods-notice">
	<a class="woocommerce-message-close notice-dismiss" href="<?php echo esc_url( mn_nonce_url( add_query_arg( 'wc-hide-notice', 'no_shipping_methods' ), 'woocommerce_hide_notices_nonce', '_wc_notice_nonce' ) ); ?>"><?php _e( 'Dismiss', 'woocommerce' ); ?></a>
