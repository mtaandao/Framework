...
return array(
	...
	'description' => __( 'Slider with MN Posts', 'js_composer' ),
	'params' => array(
		array(
			'type' => 'textfield',
		...
		array(
			...
			'description' => sprintf( __( 'Select how to sort retrieved posts. More at %s.', 'js_composer' ), '<a href="http://codex.wordpress.org/Class_Reference/MN_Query#Order_.26_Orderby_Parameters" target="_blank">Mtaandao codex page</a>' ),
		),
		array(
			'type' => 'dropdown',
			...
			'description' => sprintf( __( 'Select ascending or descending order. More at %s.', 'js_composer' ), '<a href="http://codex.wordpress.org/Class_Reference/MN_Query#Order_.26_Orderby_Parameters" target="_blank">Mtaandao codex page</a>' ),
		),
		array(
			'type' => 'textfield',
