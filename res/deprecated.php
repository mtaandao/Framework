<?php
/**
 * Deprecated functions from past Mtaandao versions. You shouldn't use these
...
/**
 * Sets up the Mtaandao Loop.
 *
 * Use The Loop instead.
 *
 * @link https://mtaandao.co.ke/docs/The_Loop
 *
 * @since 1.0.1
 * @deprecated 1.5.0
 */
function start_mn() {
	...
	_deprecated_function( __FUNCTION__, '1.5.0', __('new Mtaandao Loop') );
 ...
 *
 * @since 1.0.1
 * @deprecated 2.1.0 Use mn_list_bookmarks()
 * @see mn_list_bookmarks()
 *
 * @param string $category The category to use.
 * @param string $args
 * @return string|null
 */
function mn_get_linksbyname($category, $args = '') {
	_deprecated_function(__FUNCTION__, '2.1.0', 'mn_list_bookmarks()');
 ...
 *
 * @since 0.71
 * @deprecated 2.1.0 Use mn_list_categories()
 * @see mn_list_categories()
 *
 * @param int $optionall
 * @param string $all
...
function list_cats($optionall = 1, $all = 'All', $sort_column = 'ID', $sort_order = 'asc', $file = '', $list = true, $optiondates = 0,
	...
	_deprecated_function( __FUNCTION__, '2.1.0', 'mn_list_categories()' );

	$query = compact('optionall', 'all', 'sort_column', 'sort_order', 'file', 'list', 'optiondates', 'optioncount', 'hide_empty', 'use_desc_for_title', 'children',
		'child_of', 'categories', 'recurse', 'feed', 'feed_image', 'exclude', 'hierarchical');
	return mn_list_cats($query);
}
 ...
 */
function mn_list_cats($args = '') {
	_deprecated_function( __FUNCTION__, '2.1.0', 'mn_list_categories()' );

	$r = mn_parse_args( $args );
 ...
 *
 * @since 0.71
 * @deprecated 2.1.0 Use mn_dropdown_categories()
...
function dropdown_cats($optionall = 1, $all = 'All', $orderby = 'ID', $order = 'asc',
	...
	_deprecated_function( __FUNCTION__, '2.1.0', 'mn_dropdown_categories()' );
	...
	return mn_dropdown_categories($query);
}
 ...
 *
 * @since 1.2.0
 * @deprecated 2.1.0 Use mn_list_authors()
 * @see mn_list_authors()
 *
...
function list_authors($optioncount = false, $exclude_admin = true, $show_fullname = false, $hide_empty = true, $feed = '', $feed_image = '') {
	_deprecated_function( __FUNCTION__, '2.1.0', 'mn_list_authors()' );

	$args = compact('optioncount', 'exclude_admin', 'show_fullname', 'hide_empty', 'feed', 'feed_image');
	return mn_list_authors($args);
}
 ...
 *
 * @since 1.0.1
 * @deprecated 2.1.0 Use mn_get_post_categories()
 * @see mn_get_post_categories()
 *
 * @param int $blogid Not Used
 * @param int $post_ID
 * @return array
 */
function mn_get_post_cats($blogid = '1', $post_ID = 0) {
	_deprecated_function( __FUNCTION__, '2.1.0', 'mn_get_post_categories()' );
	return mn_get_post_categories($post_ID);
}
 ...
 * @since 1.0.1
 * @deprecated 2.1.0
 * @deprecated Use mn_set_post_categories()
 * @see mn_set_post_categories()
 *
 * @param int $blogid Not used
 * @param int $post_ID
 ...
 * @return bool|mixed
 */
function mn_set_post_cats($blogid = '1', $post_ID = 0, $post_categories = array()) {
	_deprecated_function( __FUNCTION__, '2.1.0', 'mn_set_post_categories()' );
	return mn_set_post_categories($post_ID, $post_categories);
}
 ...
 *
 * @since 0.71
 * @deprecated 2.1.0 Use mn_get_archives()
 * @see mn_get_archives()
 *
 * @param string $type
 * @param string $limit
...
function get_archives($type='', $limit='', $format='html', $before = '', $after = '', $show_post_count = false) {
	_deprecated_function( __FUNCTION__, '2.1.0', 'mn_get_archives()' );
	$args = compact('type', 'limit', 'format', 'before', 'after', 'show_post_count');
	return mn_get_archives($args);
}
 ...
 *
 * @since 0.71
 * @deprecated 2.1.0 Use mn_link_pages()
 * @see mn_link_pages()
 *
 * @param string $before
 * @param string $after
...
function link_pages($before='<br />', $after='<br />', $next_or_number='number', $nextpagelink='next page', $previouspagelink='previous page',
					$pagelink='%', $more_file='') {
	_deprecated_function( __FUNCTION__, '2.1.0', 'mn_link_pages()' );

	$args = compact('before', 'after', 'next_or_number', 'nextpagelink', 'previouspagelink', 'pagelink', 'more_file');
	return mn_link_pages($args);
}
 ...
 * $mndb->linkcategories and output it as a nested HTML unordered list.
 *
 * @since 1.0.1
 * @deprecated 2.1.0 Use mn_list_bookmarks()
 * @see mn_list_bookmarks()
...
/**
 * An alias of mn_create_user().
 *
 * @since 2.0.0
 * @deprecated 2.0.0 Use mn_create_user()
 * @see mn_create_user()
 *
...
function create_user($username, $password, $email) {
	_deprecated_function( __FUNCTION__, '2.0.0', 'mn_create_user()' );
	return mn_create_user($username, $password, $email);
}
 ...
 * @see get_terms()
 *
 * @link https://mtaandao.co.ke/docs/Function_Reference/get_all_category_ids
 *
...
function get_all_category_ids() {
	...
	if ( ! $cat_ids = mn_cache_get( 'all_category_ids', 'category' ) ) {
		$cat_ids = get_terms( 'category', array('fields' => 'ids', 'get' => 'all') );
		mn_cache_add( 'all_category_ids', $cat_ids, 'category' );
	}
 ...
 *
 * @since 1.0.0
 * @deprecated 3.0.0 Use mn_load_alloptions())
 * @see mn_load_alloptions()
 *
 * @return array List of all options.
 */
function get_alloptions() {
	_deprecated_function( __FUNCTION__, '3.0.0', 'mn_load_alloptions()' );
	return mn_load_alloptions();
}
 ...
 *
 * @since 2.0.0
 * @deprecated 2.5.0 Use mn_get_attachment_link()
 * @see mn_get_attachment_link()
 *
...
function get_the_attachment_link($id = 0, $fullsize = false, $max_dims = false, $permalink = false) {
	_deprecated_function( __FUNCTION__, '2.5.0', 'mn_get_attachment_link()' );
	$id = (int) $id;
	$_post = get_post($id);

	if ( ('attachment' != $_post->post_type) || !$url = mn_get_attachment_url($_post->ID) )
 ...
 *
 * @since 2.1.0
 * @deprecated 2.5.0 Use mn_get_attachment_image_src()
 * @see mn_get_attachment_image_src()
 *
 * @param int $id Optional. Post ID.
...
function get_attachment_icon_src( $id = 0, $fullsize = false ) {
	_deprecated_function( __FUNCTION__, '2.5.0', 'mn_get_attachment_image_src()' );
	$id = (int) $id;
	if ( !$post = get_post($id) )
		return false;
	...
	if ( !$fullsize && $src = mn_get_attachment_thumb_url( $post->ID ) ) {
		// We have a thumbnail desired, specified and existing

		$src_file = basename($src);
	} elseif ( mn_attachment_is_image( $post->ID ) ) {
		// We have an image without a thumbnail

		$src = mn_get_attachment_url( $post->ID );
		$src_file = & $file;
	} elseif ( $src = mn_mime_type_icon( $post->ID ) ) {
 ...
 *
 * @since 2.0.0
 * @deprecated 2.5.0 Use mn_get_attachment_image()
 * @see mn_get_attachment_image()
 *
 * @param int $id Optional. Post ID.
...
function get_attachment_icon( $id = 0, $fullsize = false, $max_dims = false ) {
	_deprecated_function( __FUNCTION__, '2.5.0', 'mn_get_attachment_image()' );
	$id = (int) $id;
	if ( !$post = get_post($id) )
		return false;
 ...
 */
function mn_specialchars( $string, $quote_style = ENT_NOQUOTES, $charset = false, $double_encode = false ) {
	_deprecated_function( __FUNCTION__, '2.8.0', 'esc_html()' );
	if ( func_num_args() > 1 ) { // Maintain back-compat for people passing additional arguments.
		$args = func_get_args();
		return call_user_func_array( '_mn_specialchars', $args );
	} else {
 ...
 *
 * Passes to mn_register_sidebar_widget() after argument list and backward
 * compatibility is complete.
 *
 * @since 2.2.0
 * @deprecated 2.8.0 Use mn_register_sidebar_widget()
 * @see mn_register_sidebar_widget()
 *
...
function register_sidebar_widget($name, $output_callback, $classname = '') {
	_deprecated_function( __FUNCTION__, '2.8.0', 'mn_register_sidebar_widget()' );
	// Compat
	if ( is_array($name) ) {
		if ( count($name) == 3 )
	...
	call_user_func_array('mn_register_sidebar_widget', $args);
}

/**
 * Serves as an alias of mn_unregister_sidebar_widget().
 *
 * @since 2.2.0
 * @deprecated 2.8.0 Use mn_unregister_sidebar_widget()
 * @see mn_unregister_sidebar_widget()
 *
 * @param int|string $id Widget ID.
 */
function unregister_sidebar_widget($id) {
	_deprecated_function( __FUNCTION__, '2.8.0', 'mn_unregister_sidebar_widget()' );
	return mn_unregister_sidebar_widget($id);
}
 ...
 * the array for the name.
 *
 * Passes to mn_register_widget_control() after the argument list has
 * been compiled.
 *
 * @since 2.2.0
 * @deprecated 2.8.0 Use mn_register_widget_control()
 * @see mn_register_widget_control()
 *
...
function register_widget_control($name, $control_callback, $width = '', $height = '') {
	_deprecated_function( __FUNCTION__, '2.8.0', 'mn_register_widget_control()' );
	// Compat
	if ( is_array($name) ) {
		if ( count($name) == 3 )
			$name = sprintf($name[0], $name[2]);
	...
	call_user_func_array('mn_register_widget_control', $args);
}

/**
 * Alias of mn_unregister_widget_control().
 *
 * @since 2.2.0
 * @deprecated 2.8.0 Use mn_unregister_widget_control()
 * @see mn_unregister_widget_control()
 *
 * @param int|string $id Widget ID.
 */
function unregister_widget_control($id) {
	_deprecated_function( __FUNCTION__, '2.8.0', 'mn_unregister_widget_control()' );
	return mn_unregister_widget_control($id);
}
...
function delete_usermeta( $user_id, $meta_key, $meta_value = '' ) {
	...
	$cur = $mndb->get_row( $mndb->prepare("SELECT * FROM $mndb->usermeta WHERE user_id = %d AND meta_key = %s", $user_id, $meta_key) );

	if ( $cur && $cur->umeta_id )
		do_action( 'delete_usermeta', $cur->umeta_id, $user_id, $meta_key, $meta_value );

	if ( ! empty($meta_value) )
		$mndb->query( $mndb->prepare("DELETE FROM $mndb->usermeta WHERE user_id = %d AND meta_key = %s AND meta_value = %s", $user_id, $meta_key, $meta_value) );
	else
		$mndb->query( $mndb->prepare("DELETE FROM $mndb->usermeta WHERE user_id = %d AND meta_key = %s", $user_id, $meta_key) );

	clean_user_cache( $user_id );
	mn_cache_delete( $user_id, 'user_meta' );
...
function get_usermeta( $user_id, $meta_key = '' ) {
	...
	if ( !empty($meta_key) ) {
		$meta_key = preg_replace('|[^a-z0-9_]|i', '', $meta_key);
		$user = mn_cache_get($user_id, 'users');
		// Check the cached user object
		if ( false !== $user && isset($user->$meta_key) )
			$metas = array($user->$meta_key);
		else
			$metas = $mndb->get_col( $mndb->prepare("SELECT meta_value FROM $mndb->usermeta WHERE user_id = %d AND meta_key = %s", $user_id, $meta_key) );
	} else {
		$metas = $mndb->get_col( $mndb->prepare("SELECT meta_value FROM $mndb->usermeta WHERE user_id = %d", $user_id) );
	}
...
function update_usermeta( $user_id, $meta_key, $meta_value ) {
	...
	if ( !$cur )
		$mndb->insert($mndb->usermeta, compact('user_id', 'meta_key', 'meta_value') );
	elseif ( $cur->meta_value != $meta_value )
		$mndb->update($mndb->usermeta, compact('meta_value'), compact('user_id', 'meta_key') );
	else
		return false;
	...
	if ( !$cur )
		do_action( 'added_usermeta', $mndb->insert_id, $user_id, $meta_key, $meta_value );
	else
...
function get_users_of_blog( $id = '' ) {
	...
	$users = $mndb->get_results( "SELECT user_id, user_id AS ID, user_login, display_name, user_email, meta_value FROM $mndb->users, $mndb->usermeta WHERE {$mndb->users}.ID = {$mndb->usermeta}.user_id AND meta_key = '{$blog_prefix}capabilities' ORDER BY {$mndb->usermeta}.user_id" );
	return $users;
}
...
function automatic_feed_links( $add = true ) {
	...
	if ( $add )
		...
		remove_action( 'mn_head', 'feed_links_extra', 3 ); // Just do this yourself in 3.0+
}
 ...
 * @return bool
 */
function mn_timezone_supported() {
...
function the_editor($content, $id = 'content', $prev_id = 'title', $media_buttons = true, $tab_index = 2, $extended = true) {
	...
	mn_editor( $content, $id, array( 'media_buttons' => $media_buttons ) );
}
 ...
 */
function mn_admin_bar_dashboard_view_site_menu( $mn_admin_bar ) {
	_deprecated_function( __FUNCTION__, '3.3.0' );
	...
	if ( 0 != $user_id ) {
		if ( is_admin() )
			$mn_admin_bar->add_menu( array( 'id' => 'view-site', 'title' => __( 'Visit Site' ), 'href' => home_url() ) );
		elseif ( is_multisite() )
			$mn_admin_bar->add_menu( array( 'id' => 'dashboard', 'title' => __( 'Dashboard' ), 'href' => get_dashboard_url( $user_id ) ) );
		else
			$mn_admin_bar->add_menu( array( 'id' => 'dashboard', 'title' => __( 'Dashboard' ), 'href' => admin_url() ) );
	}
}
 ...
 */
function get_themes() {
	_deprecated_function( __FUNCTION__, '3.4.0', 'mn_get_themes()' );
	...
	foreach ( $themes as $theme ) {
		$name = $theme->get('Name');
		if ( isset( $mn_themes[ $name ] ) )
			$mn_themes[ $name . '/' . $theme->get_stylesheet() ] = $theme;
		else
			$mn_themes[ $name ] = $theme;
	}
...
function get_theme( $theme ) {
	_deprecated_function( __FUNCTION__, '3.4.0', 'mn_get_theme( $stylesheet )' );
...
function get_current_theme() {
	...
	return mn_get_theme()->get('Name');
}

/**
 * Accepts matches array from preg_replace_callback in mnautop() or a string.
 *
 ...
 * @see add_theme_support()
 *
 * @param callable $mn_head_callback Call on the {@see 'mn_head'} action.
 ...
 */
function add_custom_image_header( $mn_head_callback, $admin_head_callback, $admin_preview_callback = '' ) {
	_deprecated_function( __FUNCTION__, '3.4.0', 'add_theme_support( \'custom-header\', $args )' );
	$args = array(
		'mn-head-callback'    => $mn_head_callback,
 ...
 */
function add_custom_background( $mn_head_callback = '', $admin_head_callback = '', $admin_preview_callback = '' ) {
	_deprecated_function( __FUNCTION__, '3.4.0', 'add_theme_support( \'custom-background\', $args )' );
	$args = array();
	if ( $mn_head_callback )
		$args['mn-head-callback'] = $mn_head_callback;
...
function get_theme_data( $theme_file ) {
	_deprecated_function( __FUNCTION__, '3.4.0', 'mn_get_theme()' );
	$theme = new MN_Theme( basename( dirname( $theme_file ) ), dirname( dirname( $theme_file ) ) );
 ...
 *
 * @since 2.0.4
 * @deprecated 3.4.1 Use mn_nonce_ays()
 * @see mn_nonce_ays()
 *
 * @param string $action Nonce action.
 * @return string Are you sure message.
 */
function mn_explain_nonce( $action ) {
	_deprecated_function( __FUNCTION__, '3.4.1', 'mn_nonce_ays()' );
 ...
 *
 * This is no longer needed as MN_Post lazy-loads the ancestors
 ...
 *
 * @param MN_Post &$post Post object, passed by reference (unused).
 */
 ...
 *
 * @since 2.1.0
 * @deprecated 3.5.0 Use mn_get_image_editor()
 * @see mn_get_image_editor()
 *
 * @param string $file Filename of the image to load.
 * @return resource The resulting image resource on success, Error string on failure.
 */
function mn_load_image( $file ) {
	_deprecated_function( __FUNCTION__, '3.5.0', 'mn_get_image_editor()' );
...
function image_resize( $file, $max_w, $max_h, $crop = false, $suffix = null, $dest_path = null, $jpeg_quality = 90 ) {
	...
	if ( is_mn_error( $resized ) )
		return $resized;

	$dest_file = $editor->generate_filename( $suffix, $dest_path );
	$saved = $editor->save( $dest_file );

	if ( is_mn_error( $saved ) )
		return $saved;
 ...
 * @return MN_Post|null Post object or array holding post contents and information
 */
function mn_get_single_post( $postid = 0, $mode = OBJECT ) {
 ...
 *
 * @since 0.71
 * @deprecated 3.5.0 Use mn_authenticate()
 * @see mn_authenticate()
 *
...
function user_pass_ok($user_login, $user_pass) {
	_deprecated_function( __FUNCTION__, '3.5.0', 'mn_authenticate()' );
	$user = mn_authenticate( $user_login, $user_pass );
	if ( is_mn_error( $user ) )
		return false;
 ...
 *
 * @since 2.9.0
 * @deprecated 3.5.0 Use mn_image_editor_supports()
 * @see mn_image_editor_supports()
 *
 * @param string $mime_type
 * @return bool
 */
function gd_edit_image_support($mime_type) {
	_deprecated_function( __FUNCTION__, '3.5.0', 'mn_image_editor_supports()' );
 ...
 */
function mn_convert_bytes_to_hr( $bytes ) {
...
function rich_edit_exists() {
	global $mn_rich_edit_exists;
	_deprecated_function( __FUNCTION__, '3.9.0' );

	if ( ! isset( $mn_rich_edit_exists ) )
		$mn_rich_edit_exists = file_exists( ABSPATH . RES . '/js/tinymce/tinymce.js' );

	return $mn_rich_edit_exists;
}
 ...
 *
 * Has not performed this function for many, many years. Use mndb::prepare() instead.
 *
 * @since 0.71
 * @deprecated 3.9.0
 *
 ...
 *
 * @since 2.5.0
 * @deprecated 4.0.0 Use mndb::esc_like()
 * @see mndb::esc_like()
 *
 * @param string $text The text to be escaped.
...
function like_escape($text) {
	_deprecated_function( __FUNCTION__, '4.0.0', 'mndb::esc_like()' );
 ...
 *
 * Determines if the URL can be accessed over SSL by using the Mtaandao HTTP API to access
...
function url_is_accessable_via_ssl( $url ) {
	...
	$response = mn_remote_get( set_url_scheme( $url, 'https' ) );

	if ( !is_mn_error( $response ) ) {
		$status = mn_remote_retrieve_response_code( $response );
...
function mn_richedit_pre($text) {
	...
	if ( empty( $text ) ) {
		 ...
		 * is passed to mn_richedit_pre(). If an empty string is passed, it results
		 * in a break tag and line feed.
		 *
		 * If a non-empty string is passed, the filter is evaluated on the mn_richedit_pre()
	...
	$output = mnautop($output);
	$output = htmlspecialchars($output, ENT_NOQUOTES, get_option( 'blog_charset' ) );

	/** This filter is documented in res/deprecated.php */
 ...
 */
function mn_htmledit_pre($output) {
	_deprecated_function( __FUNCTION__, '4.3.0', 'format_for_editor()' );
 ...
 * @see get_permalink()
 *
 * @param int|MN_Post $post_id Optional. Post ID or MN_Post object. Default is global $post.
 * @return string|false
 */
 ...
 */
function mn_get_http( $url, $file_path = false, $red = 1 ) {
	_deprecated_function( __FUNCTION__, '4.4.0', 'MN_Http' );
	...
	$response = mn_safe_remote_request( $url, $options );

	if ( is_mn_error( $response ) )
		return false;

	$headers = mn_remote_retrieve_headers( $response );
	$headers['response'] = mn_remote_retrieve_response_code( $response );

	// MN_HTTP no longer follows redirects for HEAD requests.
	if ( 'HEAD' == $options['method'] && in_array($headers['response'], array(301, 302)) && isset( $headers['location'] ) ) {
		return mn_get_http( $headers['location'], $file_path, ++$red );
	}
	...
	fwrite( $out_fp,  mn_remote_retrieve_body( $response ) );
	fclose($out_fp);
	clearstatcache();
 ...
 */
function mn_embed_handler_googlevideo( $matches, $attr, $url, $rawattr ) {
