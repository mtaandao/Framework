<?php
/**
 * Customize API: MN_Customize_Header_Image_Control class
 *
 * @package Mtaandao
 ...
 */
class MN_Customize_Header_Image_Control extends MN_Customize_Image_Control {
	public $type = 'header';
	...
	public function enqueue() {
		mn_enqueue_media();
		mn_enqueue_script( 'customize-views' );

		$this->prepare_control();

		mn_localize_script( 'customize-views', '_mnCustomizeHeader', array(
			'data' => array(
			...
			'nonces' => array(
				'add' => mn_create_nonce( 'header-add' ),
				'remove' => mn_create_nonce( 'header-remove' ),
			),
