...
final class WooCommerce {
	...
	private function init_hooks() {
		...
		add_action( 'init', array( $this, 'mndb_table_fix' ), 0 );
		add_action( 'switch_blog', array( $this, 'mndb_table_fix' ), 0 );
	}
	...
	/**
	 * Init WooCommerce when Mtaandao Initialises.
	 */
	 ...
	 *
	 * Locales found in:
	 *      - MN_LANG_DIR/woocommerce/woocommerce-LOCALE.mo
	 *      - MN_LANG_DIR/plugins/woocommerce-LOCALE.mo
	 */
	public function load_plugin_textdomain() {
		$locale = apply_filters( 'plugin_locale', get_locale(), 'woocommerce' );

		load_textdomain( 'woocommerce', MN_LANG_DIR . '/woocommerce/woocommerce-' . $locale . '.mo' );
	 ...
	 */
	public function mndb_table_fix() {
		global $mndb;
		$mndb->payment_tokenmeta    = $mndb->prefix . 'woocommerce_payment_tokenmeta';
		$mndb->order_itemmeta       = $mndb->prefix . 'woocommerce_order_itemmeta';
		$mndb->tables[]             = 'woocommerce_payment_tokenmeta';
		$mndb->tables[]             = 'woocommerce_order_itemmeta';

		if ( get_option( 'db_version' ) < 34370 ) {
			$mndb->woocommerce_termmeta = $mndb->prefix . 'woocommerce_termmeta';
			$mndb->tables[]             = 'woocommerce_termmeta';
		}
	}
