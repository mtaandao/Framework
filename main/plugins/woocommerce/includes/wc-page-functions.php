...
function wc_page_endpoint_title( $title ) {
	...
	if ( ! is_null( $mn_query ) && ! is_admin() && is_main_query() && in_the_loop() && is_page() && is_wc_endpoint_url() ) {
...
add_filter( 'mn_nav_menu_objects', 'wc_nav_menu_items', 10 );
...
add_filter( 'mn_nav_menu_objects', 'wc_nav_menu_item_classes', 2 );


/**
 * Fix active class in mn_list_pages for shop page.
 *
...
add_filter( 'mn_list_pages', 'wc_list_pages' );
