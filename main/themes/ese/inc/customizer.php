 ...
 * 
 * @see mn_strip_all_tags() https://developer.mtaandao.co.ke/reference/functions/mn_strip_all_tags/
 *
 ...
 * 
 * @see absint() https://developer.mtaandao.co.ke/reference/functions/absint/
 * @see get_post_status() https://developer.mtaandao.co.ke/reference/functions/get_post_status/
 *
 ...
 * 
 * @see sanitize_hex_color() https://developer.mtaandao.co.ke/reference/functions/sanitize_hex_color/
 * @link sanitize_hex_color_no_hash() https://developer.mtaandao.co.ke/reference/functions/sanitize_hex_color_no_hash/
 *
 ...
 * 'sanitize_callback'. It is wrapped in a callback here merely for example purposes.
 * 
 * @see mn_filter_post_kses() https://developer.mtaandao.co.ke/reference/functions/mn_filter_post_kses/
 *
 ...
 * 
 * @see mn_check_filetype() https://developer.mtaandao.co.ke/reference/functions/mn_check_filetype/
 *
 ...
 * 'sanitize_callback'. It is wrapped in a callback here merely for example purposes.
 * 
 * @see mn_filter_nohtml_kses() https://developer.mtaandao.co.ke/reference/functions/mn_filter_nohtml_kses/
 *
 ...
 * 
 * @see sanitize_key()               https://developer.mtaandao.co.ke/reference/functions/sanitize_key/
 * @see $mn_customize->get_control() https://developer.mtaandao.co.ke/reference/classes/mn_customize_manager/get_control/
 *
 ...
 * It is wrapped in a callback here merely for example purposes.
 * 
 * @see esc_url_raw() https://developer.mtaandao.co.ke/reference/functions/esc_url_raw/
 *
