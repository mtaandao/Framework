	...
	<?php if ( 'updater' === $tab ) : ?>
		...
		<div class="vc_settings-activation-deactivation">
			<?php if ( vc_license()->isActivated() ) : ?>
				<p>
					<?php echo __( 'You have activated Visual Composer version which allows you to access all the customer benefits. Thank you for choosing Visual Composer as your page builder. If you do not wish to use Visual Composer on this Mtaandao site you can deactivate your license below.', 'js_composer' ) ?>
				</p>
				...
				<p>
					...
					<img src="<?php echo get_admin_url() ?>/images/mnspin_light.gif" class="vc_updater-spinner"
