...
class RM_Content_View_Restrictions_Controller {

    const ACCESS_DATA_KEY = 'rm_posts_view_access_data';
    ...
    static private function get_access_data_from_post() {
        ...
        $access_error_action = $_POST['rm_post_access_error_action'];
...
// end of RM_Content_View_Restrictions_Controller class