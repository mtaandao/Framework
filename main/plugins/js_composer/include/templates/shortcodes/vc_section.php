...
if ( $has_video_bg ) {
	...
	mn_enqueue_script( 'vc_youtube_iframe_api_js' );
}

if ( ! empty( $parallax ) ) {
	mn_enqueue_script( 'vc_jquery_skrollr_js' );
...
if ( ! empty( $parallax_image ) ) {
	if ( $has_video_bg ) {
		...
		$parallax_image_src = mn_get_attachment_image_src( $parallax_image_id, 'full' );
...
$output .= wpb_js_remove_mnautop( $content );
$output .= '</section>';
$output .= $after_output;
