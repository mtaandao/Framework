...
(function( exports, $ ){
	...
	$( function() {
		...
		api.preview.bind( 'loading-initiated', function () {
			$( 'body' ).addClass( 'mn-customizer-unloading' );
		});
		api.preview.bind( 'loading-failed', function () {
			$( 'body' ).removeClass( 'mn-customizer-unloading' );
		});
		...
		api.when.apply( api, bg ).done( function( color, image, position_x, repeat, attachment ) {
			...
			update = function() {
				...
				//
				// See get_body_class() in /res/post-template.php
		 ...
		 * Custom Logo
		 *
		 * Toggle the mn-custom-logo body class when a logo is added or removed.
		 *
		 * @since 4.5.0
		 */
		api( 'custom_logo', function( setting ) {
			$( 'body' ).toggleClass( 'mn-custom-logo', !! setting.get() );
			setting.bind( function( attachmentId ) {
				$( 'body' ).toggleClass( 'mn-custom-logo', !! attachmentId );
			} );
		} );
