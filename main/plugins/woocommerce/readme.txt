...
WooCommerce is a free eCommerce plugin that allows you to sell anything, beautifully. Built to integrate seamlessly with Mtaandao, WooCommerce is the world’s favorite eCommerce solution that gives both store owners and developers complete control.

With endless flexibility and access to hundreds of free and premium Mtaandao extensions, WooCommerce now powers 30% of all online stores -- more than any other platform.
...
[Storefront](https://mtaandao.co.ke/themes/storefront/) is a free Mtaandao theme available to any WooCommerce store. Along with deep WooCommerce integration, Storefront prioritizes speed and uptime while eliminating theme and plugin conflicts during major updates.
...
Mtaandao.org is home to some amazing extensions for WooCommerce, including:

- [Google Analytics](https://mtaandao.co.ke/plugins/woocommerce-google-analytics-integration/)
- [Delivery Notes](https://mtaandao.co.ke/plugins/woocommerce-delivery-notes/)
- [PDF Invoices and Packing Slips](https://mtaandao.co.ke/plugins/woocommerce-pdf-invoices-packing-slips/)
- [Affiliates Integration Light](https://mtaandao.co.ke/plugins/affiliates-woocommerce-light/)
- [New Product Badges](https://mtaandao.co.ke/plugins/woocommerce-new-product-badge/)

Keen to see them all? Search Mtaandao.org for ‘WooCommerce’ to dive in.
...
When you download WooCommerce, you join a community of more than a million store owners, developers, and Mtaandao enthusiasts. We’re one of the fastest-growing open source communities online, and whether you’re a n00b or a Ninja, we’d love to have you!
...
Want to add a new language to WooCommerce? Swell! You can contribute via [translate.wordpress.org](https://translate.wordpress.org/projects/mn-plugins/woocommerce).
...
Automatic installation is the easiest option as Mtaandao handles the file transfers itself and you don’t need to leave your web browser. To do an automatic install of WooCommerce, log in to your Mtaandao dashboard, navigate to the Plugins menu and click Add New.
...
The manual installation method involves downloading our eCommerce plugin and uploading it to your webserver via your favourite FTP application. The Mtaandao codex contains [instructions on how to do this here](https://codex.wordpress.org/Managing_Plugins#Manual_Plugin_Installation).

= Updating =

Automatic updates should work like a charm; as always though, ensure you backup your site just in case.

If on the off-chance you do encounter issues with the shop/category pages after an update you simply need to flush the permalinks by going to Mtaandao > Settings > Permalinks and hitting 'save'. That should return things to normal.

= Dummy data =

WooCommerce comes with some dummy data you can use to see how products look; either import dummy_data.xml via the [Mtaandao importer](https://mtaandao.co.ke/extend/plugins/wordpress-importer/) or use our [CSV Import Suite plugin](https://woocommerce.com/products/product-csv-import-suite/) to import dummy_data.csv and dummy_data_variations.csv.
...
If you get stuck, you can ask for help in the [WooCommerce Plugin Forum](https://mtaandao.co.ke/support/plugin/woocommerce).
...
* Dev - API - Added support for MN REST API with custom URL prefixes.
...
* Tweak - Cache the result of WC_Comments::mn_count_comments() in a transient (improves performance).
...
* Fix - mn_cache_flush after term meta migration/update.
* Fix - wc_add_to_cart_message() when non-array is passed.
...
* Fix - Fixed referer links from cart messages in MN 4.4.
...
* Dev - All new REST API based on the MN REST API. The old WC REST API is still available, but the new one is preferred.
...
* Dev - Migrated custom term meta implementation to MN Term Meta.
...
* Tweak - Removed tag/cat classes from loops since MN does the same.
