...
if ( ! class_exists( 'Vc_Automapper' ) ) {
	...
	class Vc_Automapper {
		...
		public function addAjaxActions() {
			add_action( 'mn_ajax_vc_automapper', array(
				&$this,
				'goAction',
			) );
		...
		public function goAction() {
			vc_user_access()->checkAdminNonce()->validateDie()->mnAny( 'manage_options' )->validateDie()->part( 'settings' )->can( 'vc-automapper-tab' )->validateDie();
