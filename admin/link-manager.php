...
if ( ! current_user_can( 'manage_links' ) )
	mn_die( __( 'Sorry, you are not allowed to edit the links for this site.' ) );

$mn_list_table = _get_list_table('MN_Links_List_Table');
...
'title'		=> __('Overview'),
'content'	=>
	'<p>' . sprintf(__('You can add links here to be displayed on your site, usually using <a href="%s">Widgets</a>. By default, links to several sites in the Mtaandao community are included as examples.'), 'widgets.php') . '</p>' .
...
<?php $mn_list_table->search_box( __( 'Search Links' ), 'link' ); ?>
