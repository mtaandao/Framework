...
$menu = array();
remove_action( 'mn_head', 'print_emoji_detection_script' );
remove_action( 'mn_print_styles', 'print_emoji_styles' );
...
?>
<style type="text/css">
	#screen-meta, #adminmenumain, .notice, #mnfooter, #message, .updated {
