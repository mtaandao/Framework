...
vc_lean_map( 'vc_mn_search', null, $vc_config_path . '/mn/shortcode-vc-mn-search.php' );
vc_lean_map( 'vc_mn_meta', null, $vc_config_path . '/mn/shortcode-vc-mn-meta.php' );
vc_lean_map( 'vc_mn_recentcomments', null, $vc_config_path . '/mn/shortcode-vc-mn-recentcomments.php' );
vc_lean_map( 'vc_mn_calendar', null, $vc_config_path . '/mn/shortcode-vc-mn-calendar.php' );
vc_lean_map( 'vc_mn_pages', null, $vc_config_path . '/mn/shortcode-vc-mn-pages.php' );
vc_lean_map( 'vc_mn_tagcloud', null, $vc_config_path . '/mn/shortcode-vc-mn-tagcloud.php' );
vc_lean_map( 'vc_mn_custommenu', null, $vc_config_path . '/mn/shortcode-vc-mn-custommenu.php' );
vc_lean_map( 'vc_mn_text', null, $vc_config_path . '/mn/shortcode-vc-mn-text.php' );
vc_lean_map( 'vc_mn_posts', null, $vc_config_path . '/mn/shortcode-vc-mn-posts.php' );
vc_lean_map( 'vc_mn_links', null, $vc_config_path . '/mn/shortcode-vc-mn-links.php' );
vc_lean_map( 'vc_mn_categories', null, $vc_config_path . '/mn/shortcode-vc-mn-categories.php' );
vc_lean_map( 'vc_mn_archives', null, $vc_config_path . '/mn/shortcode-vc-mn-archives.php' );
vc_lean_map( 'vc_mn_rss', null, $vc_config_path . '/mn/shortcode-vc-mn-rss.php' );
