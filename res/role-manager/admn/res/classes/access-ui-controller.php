 ...
 * Class RM_Access_UI_Controller - base class for the access user interface controllers of add-ons, called from Role Manager page
 * Author: Mtaandao
...
// end of RM_Access_UI_Controller class