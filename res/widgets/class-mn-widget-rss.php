<?php
/**
 * Widget API: MN_Widget_RSS class
 *
 * @package Mtaandao
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see MN_Widget
 */
class MN_Widget_RSS extends MN_Widget {
	...
	public function widget( $args, $instance ) {
		...
		mn_widget_rss_output( $rss, $instance );
	...
	public function update( $new_instance, $old_instance ) {
		...
		return mn_widget_rss_process( $new_instance, $testurl );
	}
