<?php
/**
 * Dependencies API: MN_Dependencies base class
 *
 * @since 2.6.0
 *
 * @package Mtaandao
...
class MN_Dependencies {
	...
	/**
	 * An array of queued _MN_Dependency handle objects.
	 *
	 * @access public
	 * @since 2.6.8
	 * @var array
	...
	/**
	 * An array of _MN_Dependency handle objects to queue.
	 *
	 * @access public
	 * @since 2.6.0
	 * @var array
	...
	/**
	 * An array of _MN_Dependency handle objects already queued.
	 *
	 * @access public
	 * @since 2.6.0
	 * @var array
	 ...
	 * @access public
	 * @since 2.1.0
	 * @since 2.6.0 Moved from `MN_Scripts`.
	 * @since 2.8.0 Added the `$group` parameter.
	 *
	 ...
	 *
	 * @param string           $handle Name of the item. Should be unique.
	 * @param string           $src    Full URL of the item, or path of the item relative to the Mtaandao root directory.
	...
	public function add( $handle, $src, $deps = array(), $ver = false, $args = null ) {
		if ( isset($this->registered[$handle]) )
			return false;
		$this->registered[$handle] = new _MN_Dependency( $handle, $src, $deps, $ver, $args );
		return true;
	}
	 ...
	 * @since 4.0.0
	 *
	 * @param array  $queue  An array of queued _MN_Dependency handle objects.
	 * @param string $handle Name of the item. Should be unique.
	 ...
	 * @return bool|_MN_Dependency Found, or object Item data.
	 */
