...
/**
 * Upgrader Skin for Automatic Mtaandao Upgrades
 *
 ...
 */
class Automatic_Upgrader_Skin extends MN_Upgrader_Skin {
	...
	/**
	 * @param string|array|MN_Error $data
	 */
