...
class RM_Role_Additional_Options {
    
    private static $instance = null;
    private $lib = null;
    private $items = null;
    private $active_items = null;
    const STORAGE_ID = 'rm_role_additional_options_values';
    ...
    public static function get_instance($lib) {
        ...
        if (self::$instance===null) {
            self::$instance = new RM_Role_Additional_Options($lib);
        }
...
/*      
        // It's enough to update the role via RM to achieve this, that why this code is commented:
...
*/        
    ...
    private function init() {
        ...
        $this->items = array();
        $item = self::create_item('hide_admin_bar', esc_html__('Hide admin bar', 'role-manager'), 'init', 'rm_hide_admin_bar');
        $this->items[$item->id] = $item;
        
        // Allow other developers to modify the list of role's additonal options 
        $this->items = apply_filters('rm_role_additional_options', $this->items);
    ...
    public function set_active_items_hooks() {
        ...
        if (current_user_can('rm_edit_roles')) {
            return;
        }
...
?>        
    ...
    <hr />
    <?php echo esc_html__('Additional Options', 'role-manager');?>:
...
// end of RM_Role_Additional_Options class