...
class Shortcodes_Ultimate {
	...
	public static function meta_links( $links, $file ) {
		...
		if ( $file === plugin_basename( SU_PLUGIN_FILE ) ) {
			...
			$links[] = '<a href="http://mtaandao.co.ke/support/plugin/shortcodes-ultimate/" target="_blank">' . __( 'Support forum', 'shortcodes-ultimate' ) . '</a>';
			$links[] = '<a href="http://mtaandao.co.ke/extend/plugins/shortcodes-ultimate/changelog/" target="_blank">' . __( 'Changelog', 'shortcodes-ultimate' ) . '</a>';
		}
		return $links;
	}
}
