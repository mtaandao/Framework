...
class URE_Screen_Help_Pro {
    ...
    public function get_settings_general_tab($text) {
        ...
        $text .= '
            ...
            <li><strong>' . esc_html__('License key', 'user-role-editor') .'</strong> - ' .
                   'Input here the license key taken from your mtaandao.co.ke member account. This will turn on automatic updates for the User Role Editor Pro. '.
    ...
    public function get_settings_additional_modules_tab($text) {
        $text .= '<li><strong>' . esc_html__('Activate "Administrator Menu Access" module', 'user-role-editor'). '</strong> - ' .
                ...
                ' (<a href="https://www.mtaandao.co.ke/block-admin-menu-items">'. esc_html__('more info...', 'user-role-editor') .'</a>)</li>'.
                ...
                ' (<a href="https://www.mtaandao.co.ke/block-selected-widgets-under-appearance-menu">'. esc_html__('more info...', 'user-role-editor') .'</a>)</li>'.
                ...
                ' (<a href="https://www.mtaandao.co.ke/block-selected-meta-boxes">'. esc_html__('more info...', 'user-role-editor') .'</a>)</li>'.
                ...
                ' (<a href="https://www.mtaandao.co.ke/other-roles-access/">'. esc_html__('more info...', 'user-role-editor') .'</a>)</li>'.
                ...
                ' (<a href="https://www.mtaandao.co.ke/allow-user-edit-selected-posts">'. esc_html__('more info...', 'user-role-editor') .'</a>)</li>'.
        ...
        $text .= 
                ...
                ' (<a href="https://www.mtaandao.co.ke/content-view-access-restriction-selected-roles/">'. esc_html__('more info...', 'user-role-editor') .'</a>)</li>';    
