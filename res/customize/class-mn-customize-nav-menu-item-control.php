<?php
/**
 * Customize API: MN_Customize_Nav_Menu_Item_Control class
 *
 * @package Mtaandao
 ...
 * @since 4.3.0
 */
class MN_Customize_Nav_Menu_Item_Control extends MN_Customize_Control {
	 ...
	 * @since 4.3.0
	 * @access public
	 * @var MN_Customize_Nav_Menu_Item_Setting
	 */
	public $setting;
	 ...
	 * @access public
	 *
	 * @see MN_Customize_Control::__construct()
	 *
			...
			<div class="menu-item-handle">
				...
				<span class="item-controls">
					<button type="button" class="button-link item-edit" aria-expanded="false"><span class="screen-reader-text"><?php
						...
						printf( __( 'Edit menu item: %1$s (%2$s)' ), '{{ data.title || mn.customize.Menus.data.l10n.untitled }}', '{{ data.item_type_label }}' );
					?></span><span class="toggle-indicator" aria-hidden="true"></span></button>
					<button type="button" class="button-link item-delete submitdelete deletion"><span class="screen-reader-text"><?php
						/* translators: 1: Title of a menu item, 2: Type of a menu item */
						printf( __( 'Remove Menu Item: %1$s (%2$s)' ), '{{ data.title || mn.customize.Menus.data.l10n.untitled }}', '{{ data.item_type_label }}' );
					?></span></button>
				</span>
			</div>
		</div>
