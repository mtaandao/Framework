...
/**
 * Use with caution, see https://mtaandao.co.ke/docs/Function_Reference/mn_reset_vars
 */
mn_reset_vars( array( 'mn_http_referer' ) );

$mn_http_referer = remove_query_arg( array( 'action', 'message', 'tag_ID' ), $mn_http_referer );
...
<div id="message" class="updated">
	...
	<p><a href="<?php echo esc_url( $mn_http_referer ); ?>"><?php
		/* translators: %s: taxonomy name */
		printf( _x( '&larr; Back to %s', 'admin screen' ), $tax->labels->name );
	?></a></p>
	<?php } else { ?>
	<p><a href="<?php echo esc_url( mn_get_referer() ); ?>"><?php
		/* translators: %s: taxonomy name */
		printf( _x( '&larr; Back to %s', 'admin screen' ), $tax->labels->name );
	?></a></p>
	<?php } ?>
...
mn_nonce_field( 'update-tag_' . $tag_ID );
...
<?php if ( !global_terms_enabled() ) { ?>
		<tr class="form-field term-slug-wrap">
			 ...
			 * @param object|MN_Post $tag  Term or MN_Post object.
			 */
