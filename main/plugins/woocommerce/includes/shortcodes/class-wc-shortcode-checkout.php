	...
	public static function output( $atts ) {
		...
		if ( isset( $_GET['order'] ) && isset( $_GET['key'] ) ) {
			...
			if ( $order && $order->has_status( 'pending' ) ) {
				$mn->query_vars['order-pay'] = absint( $_GET['order'] );
			} else {
				$mn->query_vars['order-received'] = absint( $_GET['order'] );
			}
		}

		// Handle checkout actions
		if ( ! empty( $mn->query_vars['order-pay'] ) ) {

			self::order_pay( $mn->query_vars['order-pay'] );

		} elseif ( isset( $mn->query_vars['order-received'] ) ) {

			self::order_received( $mn->query_vars['order-received'] );
