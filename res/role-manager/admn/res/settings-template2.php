...
?>
      <tr>
        <td>
            ...
            <label for="activate_admin_menu_access_module"><?php esc_html_e('Activate Administrator Menu Access module', 'role-manager'); ?></label>
        </td>
        <td>
        </td>
      </tr>
      <tr>
        <td>
            ...
            <label for="activate_widgets_access_module"><?php esc_html_e('Activate Widgets Access module', 'role-manager'); ?></label>
        </td>
        <td>
        </td>
      </tr>
      <tr>
        <td>
            ...
            <label for="activate_meta_boxes_access_module"><?php esc_html_e('Activate Meta Boxes Access module', 'role-manager'); ?></label>
        </td>
        <td>
        </td>
      </tr>
      <tr>
        <td>
            ...
            <label for="activate_other_roles_access_module"><?php esc_html_e('Activate Other Roles Access module', 'role-manager'); ?></label>
        </td>
        <td>
        </td>
      </tr>      
      <tr>
        <td>
            ...
            <label for="manage_plugin_activation_access"><?php esc_html_e('Activate per plugin user access management for plugins activation', 'role-manager'); ?></label>
        </td>
        <td>
        </td>
      </tr>      
      <tr>
          <td cospan="2"><h3><?php esc_html_e('Content editing restrictions', 'role-manager');?></h3></td>
      </tr>
      <tr>
        <td>
            ...
            <label for="activate_create_post_capability"><?php esc_html_e('Activate "Create" capability for posts/pages/custom post types', 'role-manager'); ?></label>
        </td>
        <td>
        </td>
      </tr>      
      <tr>
        <td>
            ...
            <label for="manage_posts_edit_access"><?php esc_html_e('Activate user access management to editing selected posts, pages, custom post types', 'role-manager'); ?></label>
        </td>
        <td>
        </td>
      </tr>
      <tr>
        <td>
            ...
            <label for="force_custom_post_types_capabilities"><?php esc_html_e('Force custom post types to use their own capabilities', 'role-manager'); ?></label>
        </td>
        <td>
        </td>
      </tr>
...
?>
      <tr>
        <td>
            ...
            <label for="manage_gf_access"><?php esc_html_e('Activate per form user access management for Gravity Forms', 'role-manager'); ?></label>
        </td>
        <td> 
        </td>
      </tr>
...
?>
      <tr>
          <td cospan="2"><h3><?php esc_html_e('Content view restrictions', 'role-manager');?></h3></td>
      </tr>
      <tr>
          <td>
              ...
              <label for="activate_content_for_roles_shortcode"><?php esc_html_e('Activate [role_manager roles="role1, role2, ..."] shortcode', 'role-manager'); ?></label>
          </td>
          <td>              
          </td>
      </tr>
      <tr>
          <td>
              ...
              <label for="activate_content_for_roles"><?php esc_html_e('Activate content view restrictions', 'role-manager'); ?></label>              
          </td>
          <td>              
          </td>
      </tr>
