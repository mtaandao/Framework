 ...
 * New attributes can be added to shortcode settings by using param array in mn_map function
 *
	...
	public static function enqueueScripts() {
		...
		if ( self::isEnqueue() ) {
			foreach ( self::$enqueue_script as $item ) {
				mn_register_script( $item['name'], $item['script'], array(
					'jquery',
					'mn-color-picker',
				), WPB_VC_VERSION, true );
				mn_enqueue_script( $item['name'] );
			}
		}
	}
