 ...
 * @see MN_Upgrader
 */
class Plugin_Upgrader extends MN_Upgrader {
	 ...
	 *                                    Default true.
	 * }
	 * @return bool|MN_Error True if the install was successful, false or a MN_Error otherwise.
	 */
	 ...
	 * @return string|MN_Error The source as passed, or a MN_Error object
	...
	public function check_package($source) {
		...
		if ( ! $plugins_found )
			return new MN_Error( 'incompatible_archive_no_plugins', $this->strings['incompatible_archive'], __( 'No valid plugins were found.' ) );
	 ...
	 * @access public
	 *
	 * @param bool|MN_Error  $return Upgrade offer return.
	 * @param array          $plugin Plugin package arguments.
	 * @return bool|MN_Error The passed in $return param or MN_Error.
	 */
	public function deactivate_plugin_before_upgrade($return, $plugin) {

		if ( is_mn_error($return) ) //Bypass.
			return $return;
	 ...
	 * @global MN_Filesystem_Base $mn_filesystem Subclass
     *
	 * @param bool|MN_Error $removed
	 * @param string        $local_destination
	 * @param string        $remote_destination
	 * @param array         $plugin
	 * @return MN_Error|bool
	 */
	public function delete_old_plugin($removed, $local_destination, $remote_destination, $plugin) {
		...
		if ( ! $mn_filesystem->exists($this_plugin_dir) ) //If it's already vanished.
			return $removed;
		...
		if ( strpos($plugin, '/') && $this_plugin_dir != $plugins_dir ) //base check on if plugin includes directory separator AND that it's not the root plugin folder
			...
			$deleted = $mn_filesystem->delete($plugins_dir . $plugin);
