...
<div class="wrap woocommerce wc_addons_wrap">
			...
			<?php foreach ( $addons as $addon ) : ?>
				<li class="product">
					<a href="<?php echo esc_attr( $addon->link ); ?>">
						...
						<?php endif; ?>
						<span class="price"><?php echo mn_kses_post( $addon->price ); ?></span>
						<p><?php echo mn_kses_post( $addon->excerpt ); ?></p>
					</a>
				</li>
			<?php endforeach; ?>
			</ul>
	...
	<?php if ( 'Storefront' !== $theme['Name'] ) : ?>
		<div class="storefront">
			...
			<p><?php printf( __( 'Storefront is an intuitive, flexible and %sfree%s Mtaandao theme offering deep integration with WooCommerce and many of the most popular customer-facing extensions.', 'woocommerce' ), '<strong>', '</strong>' ); ?></p>
			<p>
				...
				<a href="<?php echo esc_url( mn_nonce_url( self_admin_url( 'update.php?action=install-theme&theme=storefront' ), 'install-theme_storefront' ) ); ?>" class="button button-primary"><?php _e( 'Download &amp; install', 'woocommerce' ); ?></a>
			</p>
		</div>
	<?php endif; ?>
</div>
