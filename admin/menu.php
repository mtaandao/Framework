...
$_mn_last_object_menu = 25; // The index of the last top-level menu in the object menu group
...
foreach ( array_merge( $builtin, $types ) as $ptype ) {
	...
	if ( $ptype_obj->show_in_menu !== true )
		continue;
	$ptype_menu_position = is_int( $ptype_obj->menu_position ) ? $ptype_obj->menu_position : ++$_mn_last_object_menu; // If we're to use $_mn_last_object_menu, increment it first.
...
$menu[59] = array( '', 'read', 'separator2', '', 'mn-menu-separator' );
...
if ( current_user_can('list_users') ) {
	$_mn_real_parent_file['profile.php'] = 'users.php'; // Back-compat for plugins adding submenus to profile.php.
	...
	$_mn_real_parent_file['users.php'] = 'profile.php';
...
$menu[99] = array( '', 'read', 'separator-last', '', 'mn-menu-separator' );

// Back-compat for old top-levels
$_mn_real_parent_file['post.php'] = 'edit.php';
$_mn_real_parent_file['post-new.php'] = 'edit.php';
$_mn_real_parent_file['edit-pages.php'] = 'edit.php?post_type=page';
$_mn_real_parent_file['page-new.php'] = 'edit.php?post_type=page';
$_mn_real_parent_file['mnmu-admin.php'] = 'tools.php';
$_mn_real_parent_file['ms-admin.php'] = 'tools.php';
