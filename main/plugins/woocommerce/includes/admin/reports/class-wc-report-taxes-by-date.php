	...
	public function get_main_chart() {
		...
		<table class="widefat">
			...
			<?php if ( ! empty( $tax_rows ) ) : ?>
				...
				<tfoot>
					<?php
						$gross     = array_sum( mn_list_pluck( (array) $tax_rows, 'total_sales' ) ) - array_sum( mn_list_pluck( (array) $tax_rows, 'total_shipping' ) );
						$total_tax = array_sum( mn_list_pluck( (array) $tax_rows, 'tax_amount' ) ) + array_sum( mn_list_pluck( (array) $tax_rows, 'shipping_tax_amount' ) );
					?>
					<tr>
						<th scope="row"><?php _e( 'Totals', 'woocommerce' ); ?></th>
						<th class="total_row"><?php echo array_sum( mn_list_pluck( (array) $tax_rows, 'total_orders' ) ); ?></th>
						<th class="total_row"><?php echo wc_price( $gross ); ?></th>
						<th class="total_row"><?php echo wc_price( array_sum( mn_list_pluck( (array) $tax_rows, 'total_shipping' ) ) ); ?></th>
