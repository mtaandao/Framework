...
<div id="message" class="updated woocommerce-message woocommerce-tracker">
	...
	<p class="submit">
		<a class="button-primary" href="<?php echo esc_url( mn_nonce_url( add_query_arg( 'wc_tracker_optin', 'true' ), 'wc_tracker_optin', 'wc_tracker_nonce' ) ); ?>"><?php _e( 'Allow', 'woocommerce' ); ?></a>
		<a class="skip button-secondary" href="<?php echo esc_url( mn_nonce_url( add_query_arg( 'wc-hide-notice', 'tracking' ), 'woocommerce_hide_notices_nonce', '_wc_notice_nonce' ) ); ?>"><?php _e( 'No, do not bother me again', 'woocommerce' ); ?></a>
	</p>
</div>
