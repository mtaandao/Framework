...
/**
 * Add MN ui pointers to backend editor.
 */
				...
				array(
					...
					'options' => array(
						'content' => sprintf( '<h3> %s </h3> <p> %s <br/><br/> %s</p>',
							...
							sprintf( __( 'P.S. Learn more at our <a href="%s" target="_blank">Knowledge Base</a>.', 'js_composer' ), 'http://kb.mtaandao.co.ke/plugins/page-builder' )
						),
						'position' => array(
							'edge' => 'left',
							'align' => 'center',
...
add_action( 'mn_enqueue_scripts', 'vc_page_editable_enqueue_pointer_scripts' );
