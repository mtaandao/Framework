...
/**
 * Base Mtaandao Filesystem class for which Filesystem implementations extend
 *
 * @since 2.5.0
 */
class MN_Filesystem_Base {
	/**
	 ...
	 * @return string The location of the remote path.
	 */
	public function mn_themes_dir( $theme = false ) {
	...
	/**
	 * Return the path on the remote filesystem of MN_LANG_DIR.
	 *
	 * @access public
	 * @since 3.2.0
	 *
	 * @return string The location of the remote path.
	 */
	public function mn_lang_dir() {
		return $this->find_folder(MN_LANG_DIR);
	}
	 ...
	 * @access public
	 * @since 2.5.0
	 * @deprecated 2.7.0 use MN_Filesystem::abspath() or MN_Filesystem::mn_*_dir() instead.
	 * @see MN_Filesystem::abspath()
	 * @see MN_Filesystem::mn_content_dir()
	 * @see MN_Filesystem::mn_plugins_dir()
	 * @see MN_Filesystem::mn_themes_dir()
	 * @see MN_Filesystem::mn_lang_dir()
	 *
	...
	public function find_base_dir( $base = '.', $echo = false ) {
		_deprecated_function(__FUNCTION__, '2.7.0', 'MN_Filesystem::abspath() or MN_Filesystem::mn_*_dir()' );
		$this->verbose = $echo;
		return $this->abspath();
	}
	 ...
	 * @access public
	 * @since 2.5.0
	 * @deprecated 2.7.0 use MN_Filesystem::abspath() or MN_Filesystem::mn_*_dir() methods instead.
	 * @see MN_Filesystem::abspath()
	 * @see MN_Filesystem::mn_content_dir()
	 * @see MN_Filesystem::mn_plugins_dir()
	 * @see MN_Filesystem::mn_themes_dir()
	...
	public function search_for_folder( $folder, $base = '.', $loop = false ) {
		...
		foreach ( $folder_parts as $index => $key ) {
			...
			/*
			 * Working from /home/ to /user/ to /mtaandao/ see if that file exists within
			 * the current folder, If it's found, change into it and follow through looking
			 * for it. If it cant find Mtaandao down that route, it'll continue onto the next
		...
		// This comes into effect when the CWD is /home/user/ but MN is at /var/www/....
	 ...
	 * @abstract
	 *
	 * @return bool True on success or false on failure (always true for MN_Filesystem_Direct).
	 */
