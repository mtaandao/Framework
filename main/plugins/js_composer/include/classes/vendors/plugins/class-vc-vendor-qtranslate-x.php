...
class Vc_Vendor_QtranslateX implements Vc_Vendor_Interface {
	...
	public function enqueueJsBackend() {
		mn_enqueue_script( 'vc_vendor_qtranslatex_backend', vc_asset_url( 'js/vendors/qtranslatex_backend.js' ), array(
			'vc-backend-min-js',
			'jquery',
		), '1.0', true );
	}
	...
	public function enqueueJsFrontend() {
		mn_enqueue_script( 'vc_vendor_qtranslatex_frontend', vc_asset_url( 'js/vendors/qtranslatex_frontend.js' ), array(
