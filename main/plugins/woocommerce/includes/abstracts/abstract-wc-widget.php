 ...
 * @extends  MN_Widget
 */
abstract class WC_Widget extends MN_Widget {
	...
	public function get_cached_widget( $args ) {
		...
		$cache = mn_cache_get( apply_filters( 'woocommerce_cached_widget_id', $this->widget_id ), 'widget' );
	...
	public function cache_widget( $args, $content ) {
		mn_cache_set( apply_filters( 'woocommerce_cached_widget_id', $this->widget_id ), array( $args['widget_id'] => $content ), 'widget' );
	...
	public function flush_widget_cache() {
		mn_cache_delete( apply_filters( 'woocommerce_cached_widget_id', $this->widget_id ), 'widget' );
	}
	...
	public function update( $new_instance, $old_instance ) {
		...
		foreach ( $this->settings as $key => $setting ) {
			...
			switch ( $setting['type'] ) {
				...
				break;
				case 'textarea' :
					$instance[ $key ] = mn_kses( trim( mn_unslash( $new_instance[ $key ] ) ), mn_kses_allowed_html( 'post' ) );
				break;
				case 'checkbox' :
