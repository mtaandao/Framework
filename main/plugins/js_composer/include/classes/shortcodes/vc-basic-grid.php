...
class WPBakeryShortCode_VC_Basic_Grid extends WPBakeryShortCode_Vc_Pageable {
	...
	public function shortcodeScripts() {
		...
		mn_register_script( 'vc_grid-js-imagesloaded', vc_asset_url( 'lib/bower/imagesloaded/imagesloaded.pkgd.min.js' ) );
		mn_register_script( 'vc_grid', vc_asset_url( 'js/dist/vc_grid.min.js' ), array(
				'jquery',
				'underscore',
	...
	public function enqueueScripts() {
		...
		mn_enqueue_script( 'vc_grid-js-imagesloaded' );
		mn_enqueue_script( 'vc_grid' );
	}
	...
	public function buildItems() {
		...
		foreach ( $post_data as $post ) {
			$post->filter_terms = mn_get_object_terms( $post->ID, $this->atts['filter_source'], array( 'fields' => 'ids' ) );
			$this->filter_terms = mn_parse_args( $this->filter_terms, $post->filter_terms );
			$this->items[] = $post;
		}
	}
