...
class Walker_Comment extends Walker {
	 ...
	 *
	 * @param MN_Comment $element           Comment data object.
	 ...
	 *
	 * @param string     $output  Used to append additional content. Passed by reference.
	 * @param MN_Comment $comment Comment data object.
	 ...
	 *
	 * @param string     $output  Used to append additional content. Passed by reference.
	 * @param MN_Comment $comment The current comment object. Default current comment.
	 * @param int        $depth   Optional. Depth of the current comment. Default 0.
	 * @param array      $args    Optional. An array of arguments. Default empty array.
	 */
...
<?php
	 ...
	 * @see mn_list_comments()
	 *
	 * @param MN_Comment $comment Comment to display.
	 * @param int        $depth   Depth of the current comment.
	 * @param array      $args    An array of arguments.
	 */
