 ...
 * res/ms-files.php (main/blogs.php in MU).
 *
 * @since 3.0.0
 *
...
function ms_upload_constants() {
	...
	// This is handled in mn_upload_dir() by ignoring UPLOADS for this case.
	if ( ! defined( 'UPLOADS' ) ) {
		define( 'UPLOADS', UPLOADBLOGSDIR . "/{$mndb->blogid}/files/" );
...
function ms_file_constants() {
	 ...
	 * @since 3.0.0
	 */
	if ( !defined( 'MNMU_SENDFILE' ) )
		define( 'MNMU_SENDFILE', false );

	/**
	 * Optional support for X-Accel-Redirect header
	 * @since 3.0.0
	 */
	if ( !defined( 'MNMU_ACCEL_REDIRECT' ) )
		define( 'MNMU_ACCEL_REDIRECT', false );
}
