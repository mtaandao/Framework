...
class WC_Admin_Permalink_Settings {
	...
	public function settings() {
		echo mnautop( __( 'These settings control the permalinks used specifically for products.', 'woocommerce' ) );
		...
		<table class="form-table wc-permalink-structure">
			<tbody>
				...
				<tr>
					...
					<td>
						<input name="product_permalink_structure" id="woocommerce_permalink_structure" type="text" value="<?php echo esc_attr( $product_permalink ); ?>" class="regular-text code"> <span class="description"><?php _e( 'Enter a custom base to use. A base <strong>must</strong> be set or Mtaandao will use default instead.', 'woocommerce' ); ?></span>
					</td>
				</tr>
			</tbody>
		</table>
