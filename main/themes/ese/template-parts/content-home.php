<?php
/**
 * The template used for displaying page content in templates/page-home.php
 *
 * @package Ese
 */
...
<?php
    ...
    $color_value = get_post_meta( get_the_ID(), 'ese-home-bg-color', true ); 
    // Checks and returns the color value
  	$color = (!empty( $color_value ) ? 'background-color:' . $color_value . ';' : '');

  	// Gets the stored height value 
    $height_value = get_post_meta( get_the_ID(), 'ese-home-height', true ); 
...
<div class="home" style="<?php echo $color . $bg . $height; ?> "></div>

<div class="ese-page-home">
	<div class="mdl-grid ese-1600">
		<div class="mdl-cell mdl-cell--2-col mdl-cell--hide-tablet mdl-cell--hide-phone"></div>
		<div class="mdl-cell mdl-cell--8-col mdl-card mdl-shadow--2dp home-content"> 
