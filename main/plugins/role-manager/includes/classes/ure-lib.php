    ...
    protected function capability_help_link($capability) {
        ...
        switch ($capability) {
            ...
            case 'update_core':
                ...
                break;
            case 'ure_edit_roles':
                $url = 'https://www.mtaandao.co.ke/user-role-editor-4-18-new-permissions/';
                break;
            default:
                $url = '';
        }
...
?>		  
            ...
            <a class="ure_rsb_link" style="background-image:url(<?php echo URE_PLUGIN_URL . 'images/user-role-editor-icon.png'; ?>);" target="_blank" href="https://www.mtaandao.co.ke"><?php _e('Plugin webpage', 'user-role-editor'); ?></a><br/>
            <a class="ure_rsb_link" style="background-image:url(<?php echo URE_PLUGIN_URL . 'images/user-role-editor-icon.png'; ?>);" target="_blank" href="https://www.mtaandao.co.ke/download-plugin"><?php _e('Plugin download', 'user-role-editor'); ?></a><br/>
            <a class="ure_rsb_link" style="background-image:url(<?php echo URE_PLUGIN_URL . 'images/changelog-icon.png'; ?>);" target="_blank" href="https://www.mtaandao.co.ke/changelog"><?php _e('Changelog', 'user-role-editor'); ?></a><br/>
