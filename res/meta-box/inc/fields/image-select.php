...
class RWMB_Image_Select_Field extends RWMB_Field {
	...
	static function admin_enqueue_scripts() {
		mn_enqueue_style( 'rwmb-image-select', RWMB_CSS_URL . 'image-select.css', array(), RWMB_VER );
		mn_enqueue_script( 'rwmb-image-select', RWMB_JS_URL . 'image-select.js', array( 'jquery' ), RWMB_VER, true );
	}
