...
add_action( 'mn_ajax_vc_action_save_settings_preset', 'vc_action_save_settings_preset' );
add_action( 'mn_ajax_vc_action_set_as_default_settings_preset', 'vc_action_set_as_default_settings_preset' );
add_action( 'mn_ajax_vc_action_delete_settings_preset', 'vc_action_delete_settings_preset' );
add_action( 'mn_ajax_vc_action_restore_default_settings_preset', 'vc_action_restore_default_settings_preset' );
add_action( 'mn_ajax_vc_action_get_settings_preset', 'vc_action_get_settings_preset' );
add_action( 'mn_ajax_vc_action_render_settings_preset_popup', 'vc_action_render_settings_preset_popup' );
add_action( 'mn_ajax_vc_action_render_settings_preset_title_prompt', 'vc_action_render_settings_preset_title_prompt' );
add_action( 'mn_ajax_vc_action_render_settings_templates_prompt', 'vc_action_render_settings_templates_prompt' );
...
function vc_include_settings_preset_class() {
	vc_user_access()->checkAdminNonce()->validateDie()->mnAny( 'edit_posts', 'edit_pages' )->validateDie()->part( 'presets' )->can()->validateDie();
...
function vc_action_render_settings_templates_prompt() {
	vc_user_access()->checkAdminNonce()->validateDie()->mnAny( 'edit_posts', 'edit_pages' )->validateDie()->part( 'templates' )->can()->validateDie();
