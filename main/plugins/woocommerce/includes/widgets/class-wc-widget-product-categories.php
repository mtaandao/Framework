...
class WC_Widget_Product_Categories extends WC_Widget {
	...
	public function widget( $args, $instance ) {
		...
		if ( is_tax( 'product_cat' ) ) {
			...
			$this->current_cat   = $mn_query->queried_object;
		...
		if ( $dropdown ) {
			...
			$dropdown_args = mn_parse_args( $dropdown_args, $dropdown_defaults );
		...
		// List
			...
			mn_list_categories( apply_filters( 'woocommerce_product_categories_widget_args', $list_args ) );
