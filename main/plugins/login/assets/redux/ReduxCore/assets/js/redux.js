...
(function( $ ) {
    ...
    $.redux.initEvents = function() {
        ...
        $( '#toplevel_page_' + redux.args.slug + ' .mn-submenu a, #admin-bar-' + redux.args.slug + ' a.ab-item' ).click(
            function( e ) {

                if ( ( $( '#toplevel_page_' + redux.args.slug ).hasClass( 'mn-menu-open' ) || $( this ).hasClass( 'ab-item' ) ) && !$( this ).parents( 'ul.ab-submenu:first' ).hasClass( 'ab-sub-secondary' ) ) {
                    e.preventDefault();
    ...
    $.redux.tabCheck = function() {
        $( '.redux-group-tab-link-a' ).click(
            function() {
                ...
                el.find( '#toplevel_page_' + redux.args.slug + ' .mn-submenu a.current' ).removeClass( 'current' );
                el.find( '#toplevel_page_' + redux.args.slug + ' .mn-submenu li.current' ).removeClass( 'current' );

                el.find( '#toplevel_page_' + redux.args.slug + ' .mn-submenu a' ).each(
                    function() {
                        var url = $( this ).attr( 'href' ).split( '&tab=' );
