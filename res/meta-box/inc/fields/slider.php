...
class RWMB_Slider_Field extends RWMB_Field {
	...
	static function admin_enqueue_scripts() {
		...
		mn_enqueue_style( 'jquery-ui-core', "{$url}/jquery.ui.core.css", array(), '1.8.17' );
		mn_enqueue_style( 'jquery-ui-theme', "{$url}/jquery.ui.theme.css", array(), '1.8.17' );
		mn_enqueue_style( 'jquery-ui-slider', "{$url}/jquery.ui.slider.css", array(), '1.8.17' );
		mn_enqueue_style( 'rwmb-slider', RWMB_CSS_URL . 'slider.css' );

		mn_enqueue_script( 'rwmb-slider', RWMB_JS_URL . 'slider.js', array( 'jquery-ui-slider', 'jquery-ui-widget', 'jquery-ui-mouse', 'jquery-ui-core' ), RWMB_VER, true );
	}
	...
	static function html( $meta, $field ) {
		return sprintf(
			...
			$field['id'], esc_attr( mn_json_encode( $field['js_options'] ) ),
