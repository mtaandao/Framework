 ...
 * @since 4.3
 */
class Vc_Vendor_Jmnlayer implements Vc_Vendor_Interface {
	/**
	...
	public function renderShortcodes( $output ) {
		...
		$data = JMN6_Shortcode::the_content_filter( $output );
	...
	public function vc_load_iframe_jscss() {
		mn_enqueue_script( 'vc_vendor_jwplayer', vc_asset_url( 'js/frontend_editor/vendors/plugins/jwplayer.js' ), array( 'jquery' ), '1.0', true );
	}
}
