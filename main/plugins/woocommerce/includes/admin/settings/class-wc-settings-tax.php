...
class WC_Settings_Tax extends WC_Settings_Page {
	...
	public function output_tax_rates() {
		...
		mn_localize_script( 'wc-settings-tax', 'htmlSettingsTaxLocalizeScript', array(
			'current_class' => $current_class,
			'wc_tax_nonce'  => mn_create_nonce( 'wc_tax_nonce-class:' . $current_class ),
			'base_url'      => $base_url,
		...
		mn_enqueue_script( 'wc-settings-tax' );
	...
	public function save_tax_rates() {
		...
		$tax_rate_order = absint( $mndb->get_var( $mndb->prepare( "SELECT tax_rate_order FROM {$mndb->prefix}woocommerce_tax_rates WHERE tax_rate_id = %s", $first_tax_rate_id ) ) );
