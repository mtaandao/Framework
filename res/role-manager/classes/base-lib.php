...
class RM_Base_Lib {
    ...
    public static function get_instance($options_id = '') {
        if (self::$instance===null) {        
            self::$instance = new RM_Base_Lib($options_id);
        }
 ...
 **/    
    ...
    /**
     * class constructor
     * @param string $option_name   identifire to save/retrieve plugin options to/from mn_option DB table
     */
    ...
    /**
     * Delete RM option with name option_name
