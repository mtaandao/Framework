...
function wc_get_account_menu_item_classes( $endpoint ) {
	...
	$current = isset( $mn->query_vars[ $endpoint ] );
	if ( 'dashboard' === $endpoint && ( isset( $mn->query_vars['page'] ) || empty( $mn->query_vars ) ) ) {
...
function wc_get_account_saved_payment_methods_list( $list, $customer_id ) {
	...
	foreach ( $payment_tokens as $payment_token ) {
		...
		$delete_url      = mn_nonce_url( $delete_url, 'delete-payment-method-' . $payment_token->get_id() );
		$set_default_url = wc_get_endpoint_url( 'set-default-payment-method', $payment_token->get_id() );
		$set_default_url = mn_nonce_url( $set_default_url, 'set-default-payment-method-' . $payment_token->get_id() );
