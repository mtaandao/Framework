 ...
 * @see SimplePie_Cache
 */
class MN_Feed_Cache extends SimplePie_Cache {
	 ...
	 * @return MN_Feed_Cache_Transient Feed cache handler object that uses transients.
	 */
	public function create($location, $filename, $extension) {
		return new MN_Feed_Cache_Transient($location, $filename, $extension);
	}
}
...
class MN_Feed_Cache_Transient {
	...
	public function __construct($location, $filename, $extension) {
		 ...
		 */
		$this->lifetime = apply_filters( 'mn_feed_cache_transient_lifetime', $lifetime, $filename);
	}
 ...
 */
class MN_SimplePie_Sanitize_KSES extends SimplePie_Sanitize {

	/**
	 * Mtaandao SimplePie sanitization using KSES.
	 *
