...
( function( $, data, mn, ajaxurl ) {
	$( function() {
		var $table          = $( '.wc-shipping-zone-methods' ),
			...
			$row_template   = mn.template( 'wc-shipping-zone-method-row' ),
			$blank_template = mn.template( 'wc-shipping-zone-method-row-blank' ),
...
})( jQuery, shippingZoneMethodsLocalizeScript, mn, ajaxurl );
