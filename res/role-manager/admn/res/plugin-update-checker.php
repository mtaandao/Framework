 ...
 */
	...
	/**
	 * Retrieve plugin info from the configrmd API endpoint.
	 * 
	 * @uses mn_remote_get()
	 * 
   ...
   $pluginInfo->filename = $this->pluginFile;
	...
	/**
	 * Retrieve the latest update (if any) from the configrmd API endpoint.
	 *
	...
	/**
	 * Check for updates if the configrmd check interval has already elapsed.
	 ...
	 *     - Configrmd check period in hours.
	 ...
	 * use the configrmd API endpoint to satisfy them. 
	 * 
	 * @see plugins_api()
	 * 
	 * @param mixed $result
...
class PluginInfo_1_3 {
 ...
 public $filename;
	...
	/**
	 * Transform plugin info into the format used by the native mtaandao.co.ke API
	 * 
	 * @return object
	 */
	public function toWpFormat(){
		...
		//as those returned by the native mtaandao.co.ke API. These can be assigned directly. 
		$sameFormat = array(
