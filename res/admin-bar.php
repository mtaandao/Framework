...
function _get_admin_bar_pref( $context = 'front', $user = 0 ) {
	...
	<script src="https://code.getmdl.io/1.2.1/material.min.js"></script>
								...
								$(document).ready(function(){
								    $("#more_verty").click(function(){
								        $("moren").show();
								    });
								});
								</script>
	<?php
		add_action( 'loop_start', 'on_front_logged' );
		function on_front_logged() {
		...
		<?php  } 
				...
				<a id="hide" href="#">
					<button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect" id="hide"><i class="material-icons" style="color:red">highlight_off</i>
				</button></a>
				</spand>
			<a id="show">
			    <button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect"><i class="fa fa-share-alt"></i></button></a>
			<a id="more_verty"><i class="material-icons">more_vert</i></a>
			<?php 
		}
	}
