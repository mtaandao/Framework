...
class Vc_Templates_Editor implements Vc_Render {
	...
	public function init() {
		...
		add_action( 'mn_ajax_wpb_save_template', array( &$this, 'save' ) );
		add_action( 'mn_ajax_vc_backend_template', array( &$this, 'load' ) );
		add_action( 'mn_ajax_wpb_load_template_shortcodes', array(
			&$this,
			'loadTemplateShortcodes',
		) );
		add_action( 'mn_ajax_vc_backend_default_template', array(
			&$this,
			'getBackendDefaultTemplate',
		) );
		add_action( 'mn_ajax_wpb_delete_template', array( &$this, 'delete' ) );
	}
