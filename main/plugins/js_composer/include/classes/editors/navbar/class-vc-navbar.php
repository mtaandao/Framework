...
class Vc_Navbar implements Vc_Render {
	 ...
	 * @var string
	 */
	protected $brand_url = 'http://vc.mtaandao.co.ke/plugins/page-builder/?utm_campaign=VCplugin&utm_source=vc_user&utm_medium=backend_editor';
	/**
	 * @var string
	 */
	 ...
	 * @param MN_Post $post
	 */
	public function __construct( MN_Post $post ) {
		$this->post = $post;
	}
