...
class Vc_Grid_Item_Preview {
	...
	public function enqueue() {
		...
		mn_enqueue_script( 'prettyphoto' );
		mn_enqueue_style( 'prettyphoto' );
	...
	public function mockingPost() {
		...
		$post->post_content = __( 'The Mtaandao Excerpt is an optional summary or description of a post; in short, a post summary.', 'js_composer' );
		$post->post_excerpt = __( 'The Mtaandao Excerpt is an optional summary or description of a post; in short, a post summary.', 'js_composer' );
