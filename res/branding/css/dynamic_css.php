...
<style type="text/css" media="screen">
	...
	#slate__colorSchemes .premadeColors label {
		border-color: <?php echo custom_branding_sanitize_hex( $colorSelected['contentDividerColor'] ); ?>;
	}
	#slate__colorSchemes .premadeColors label.selected,
	#slate__colorSchemes .premadeColors label:hover {
		background: <?php echo custom_branding_sanitize_hex( $colorSelected['contentDividerColor'] ); ?>;
		border-color: <?php echo custom_branding_sanitize_hex( $colorSelected['contentDividerColor'] ); ?>;
	}
	...
	/* *********************** */
	body.login {
		background-color: <?php echo custom_branding_sanitize_hex( $colorSelected['loginBgColor'] ); ?>;
	}
	#loginform {
		background-color: <?php echo custom_branding_sanitize_hex( $colorSelected['loginFormBgColor'] ); ?>;
	}
	.login h1 a {
		<?php if ( $colorDefault == $colorSelected || $colorCoffee == $colorSelected || $colorEctoplasm == $colorSelected || $colorMidnight == $colorSelected || $colorSunrise == $colorSelected ) { ?>
			background-image: url(<?php echo admin_url(); ?>/images/m-logo-w.png?ver=20131202);
			background-image: none,url(<?php echo admin_url(); ?>/images/mtaandao-logo-white.svg?ver=20131107);
		<?php	} ?>
	}
	#loginform label {
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['loginFormTextColor'] ); ?>;
	}
	#loginform input {
		background-color: <?php echo custom_branding_sanitize_hex( $colorSelected['loginFormInputBgColor'] ); ?>;
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['loginFormInputTextColor'] ); ?>;
	}
	#loginform input:focus {
		border: 1px solid <?php echo custom_branding_sanitize_hex( $colorSelected['loginFormInputFocusColor'] ); ?>;
	}
	...
	.login #backtoblog a, 
	.login #nav a {
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['loginFormLinkColor'] ); ?>;
	}
	.login #backtoblog a:hover, 
	.login #nav a:hover {
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['loginFormLinkHoverColor'] ); ?>;
	}
	#loginform .button-primary {
		border-color: <?php echo custom_branding_sanitize_hex( $colorSelected['loginButtonBgColor'] ); ?>;
		background-color: <?php echo custom_branding_sanitize_hex( $colorSelected['loginButtonBgColor'] ); ?>;
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['loginButtonTextColor'] ); ?>;
	}
	#loginform .button-primary:hover {
		border-color: <?php echo custom_branding_sanitize_hex( $colorSelected['loginButtonHoverBgColor'] ); ?>;
		background-color: <?php echo custom_branding_sanitize_hex( $colorSelected['loginButtonHoverBgColor'] ); ?>;
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['loginButtonHoverTextColor'] ); ?>;
	}
	...
	/* Background */
	#adminmenuback {
		background-color: <?php echo custom_branding_sanitize_hex( $colorSelected['adminMenuBgColor'] ); ?>;
		<?php if ('on' == $custom_branding_settings['colorsHideShadows']) { ?>
	...
	#adminmenu #collapse-menu {
		border-top-color: <?php echo custom_branding_sanitize_hex( $colorSelected['adminMenuDividerColor'] ); ?>;
	}
	...
	#collapse-menu #collapse-button div:after {
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['adminTopLevelTextColor'] ); ?>;
	}
	...
	#adminmenu li:hover div.mn-menu-image:before {
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['adminTopLevelTextHoverColor'] ); ?>;
	}
	...
	#adminmenu li.mn-has-current-submenu:hover div.mn-menu-image:before {
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['adminTopLevelSelectedTextColor'] ); ?>;
	}
	/* Folded Top Menu Text Color */
	#adminmenu .mn-submenu .mn-submenu-head,
	.folded #adminmenu .mn-submenu .mn-submenu-head {
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['adminTopLevelFoldedTextColor'] ); ?>;
	}
	...
	.folded #adminmenu .mn-has-current-submenu .mn-submenu .mn-submenu-head {
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['adminTopLevelSelectedFoldedTextColor'] ); ?>;
	}
	/* Folded Top Menu and Submenu Background Color */
	.folded #adminmenu li.mn-has-current-submenu a.mn-has-current-submenu {
		background: <?php echo custom_branding_sanitize_hex( $colorSelected['adminTopLevelSelectedFoldedBg'] ); ?>;
	}
	...
	.folded #adminmenu li.mn-has-current-submenu:hover div.mn-menu-image:before {
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['adminTopLevelSelectedFoldedIconColor'] ); ?>;
	}
	@media only screen and (max-width: 960px) {
	...
	#adminmenu .mn-has-current-submenu.opensub .mn-submenu a {
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['adminOpenSubmenuTextColor'] ); ?>;
	}
	...
	#adminmenu .mn-has-current-submenu.opensub .mn-submenu a:hover {
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['adminOpenSubmenuTextHoverColor'] ); ?>;
	}
	...
	#adminmenu a.mn-has-current-submenu:focus+.mn-submenu li.current a {
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['adminOpenSubmenuTextSelectedColor'] ); ?>;
	}
	/* Floating Submenu Background */
	#adminmenu .mn-submenu {
		background: <?php echo custom_branding_sanitize_hex( $colorSelected['adminFloatingSubmenuBgColor'] ); ?>;
	}
	/* Submenu Arrow Color */
	#adminmenu li.mn-has-submenu.mn-not-current-submenu.opensub:hover:after {
		border-right-color: <?php echo custom_branding_sanitize_hex( $colorSelected['adminFloatingSubmenuBgColor'] ); ?>;
	}
	/* Floating Submenu Text Color */
	#adminmenu .opensub .mn-submenu a {
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['adminFloatingSubmenuTextColor'] ); ?>;
	}
	/* Floating Submenu Text Hover Color */
	#adminmenu .opensub .mn-submenu a:hover {
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['adminFloatingSubmenuTextHoverColor'] ); ?>;
	}
	...
	.folded #adminmenu .mn-has-current-submenu.opensub .mn-submenu a:hover {
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['adminFoldedFloatingSubmenuTextHoverColor'] ); ?>;
	}
	...
	.folded #adminmenu .mn-has-current-submenu.opensub .mn-submenu a {
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['adminFoldedFloatingSubmenuTextColor'] ); ?>;
	}
	...
	.folded #adminmenu .opensub .mn-submenu li.current a:hover {
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['adminFoldedFloatingSubmenuSelectedTextColor'] ); ?>;
	}
	@media only screen and (max-width: 960px) {
		#adminmenu .mn-submenu li.current a,
	...
	#adminmenu li.current a .awaiting-mod {
		background: <?php echo custom_branding_sanitize_hex( $colorSelected['adminNoticeBgColor'] ); ?>;
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['adminNoticeColor'] ); ?>;
	}
	...
	/* *********************** */
	#mnfooter {
		background-color: <?php echo custom_branding_sanitize_hex( $colorSelected['footerBgColor'] ); ?>;
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['footerTextColor'] ); ?>;
	}
	#mnfooter a {
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['footerLinkColor'] ); ?>;
	}
	#mnfooter a:hover {
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['footerLinkHoverColor'] ); ?>;
	}
	...
	.view-switch a.current:before {
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['contentLinkColor'] ); ?>;
	}
	a:hover {
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['contentLinkHoverColor'] ); ?>;
	}
	/* Text Color */
	...
	.ac_match, 
	.subsubsub a.current {
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['contentTextColor'] ); ?>;
	}
	/* Icon Colors */ 
	...
	.insert-media.add_media:hover span.mn-media-buttons-icon:before {
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['contentStandardButtonTextHoverColor'] ); ?>;
	}
	input[type=radio]:checked:before {
		background: <?php echo custom_branding_sanitize_hex( $colorSelected['contentTextColor'] ); ?>;
	}
	/* Arrow Color */
	...
	th.sortable a:focus, 
	th.sortable a:hover {
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['contentHeadingTextColor'] ); ?>;
	}
	/* Form Focus Color */
	...
	select:focus, 
	textarea:focus {
		border-color: <?php echo custom_branding_sanitize_hex( $colorSelected['contentLinkHoverColor'] ); ?>;
	}
	/* Table Nav */
	.tablenav .tablenav-pages a:focus, 
	.tablenav .tablenav-pages a:hover {
		background: <?php echo custom_branding_sanitize_hex( $colorSelected['contentLinkHoverColor'] ); ?>;
		color: #fff;
	}
	...
	#col-leftback {
		background-color: <?php echo custom_branding_sanitize_hex( $colorSelected['sidebarBgColor'] ); ?>;
		<?php if ('on' == $custom_branding_settings['colorsHideShadows']) { ?>
			background-image: none;
		<?php	} ?>
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['sidebarTextColor'] ); ?>;
	}
	...
	.edit-tags-php #col-left,
	#col-leftback {
		background-color: <?php echo custom_branding_sanitize_hex( $colorSelected['contentTableRowBgHoverColor'] ); ?>;
	}
	#poststuff h3 {
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['sidebarHeadingColor'] ); ?>;
	}
	/* Icon Colors */
	...
	.postbox .curtime #timestamp:before {
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['sidebarIconColor'] ); ?>;
	}
	.postbox .howto,
	...
	/* Links */
	.postbox a {
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['sidebarLinkColor'] ); ?>;
	}
	.postbox a:hover {
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['sidebarLinkHoverColor'] ); ?>;
	}
	/* Inputs */
	...
	.postbox textarea:focus {
		border-color: <?php echo custom_branding_sanitize_hex( $colorSelected['sidebarLinkColor'] ); ?>;
	}
	/* Arrow Color */
	...
	/* Divider */
	.postbox {
		border-color: <?php echo custom_branding_sanitize_hex( $colorSelected['sidebarDividerColor'] ); ?>;
	}

	/* Content Buttons */
	.mn-core-ui .button.button-primary {
		background: <?php echo custom_branding_sanitize_hex( $colorSelected['contentPrimaryButtonBgColor'] ); ?>;
		border-color: <?php echo custom_branding_sanitize_hex( $colorSelected['contentPrimaryButtonBgColor'] ); ?>;
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['contentPrimaryButtonTextColor'] ); ?>;
	}
	.mn-core-ui .button.button-primary:hover {
		background: <?php echo custom_branding_sanitize_hex( $colorSelected['contentPrimaryButtonBgHoverColor'] ); ?>;
		border-color: <?php echo custom_branding_sanitize_hex( $colorSelected['contentPrimaryButtonBgHoverColor'] ); ?>;
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['contentPrimaryButtonTextHoverColor'] ); ?>;
	}
	.mn-core-ui .button, 
	.mn-core-ui .button-secondary,
	.comment-php #minor-publishing .button {
		background: <?php echo custom_branding_sanitize_hex( $colorSelected['contentStandardButtonBgColor'] ); ?>;
		border-color: <?php echo custom_branding_sanitize_hex( $colorSelected['contentStandardButtonBgColor'] ); ?>;
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['contentStandardButtonTextColor'] ); ?>;
	}
	...
	.mn-core-ui .button:focus, 
	.mn-core-ui .button:hover {
		background: <?php echo custom_branding_sanitize_hex( $colorSelected['contentStandardButtonBgHoverColor'] ); ?>;
		border-color: <?php echo custom_branding_sanitize_hex( $colorSelected['contentStandardButtonBgHoverColor'] ); ?>;
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['contentStandardButtonTextHoverColor'] ); ?>;
	}
	/* TinyMCE Tabs */
	.mn-switch-editor.switch-html,
	.mn-switch-editor:hover {
		background: <?php echo custom_branding_sanitize_hex( $colorSelected['contentDividerColor'] ); ?> !important;
	}
	.html-active .switch-html, 
	.tmce-active .switch-tmce {
		background: <?php echo custom_branding_sanitize_hex( $colorSelected['contentStandardButtonBgColor'] ); ?> !important;
	}
	/* Add New Button */
	.wrap .add-new-h2, 
	...
	.mn-core-ui .postbox .button.button-primary {
		background: <?php echo custom_branding_sanitize_hex( $colorSelected['sidebarPrimaryButtonBgColor'] ); ?>;
		border-color: <?php echo custom_branding_sanitize_hex( $colorSelected['sidebarPrimaryButtonBgColor'] ); ?>;
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['sidebarPrimaryButtonTextColor'] ); ?>;
	} 
	.mn-core-ui .postbox .button.button-primary:hover {
		background: <?php echo custom_branding_sanitize_hex( $colorSelected['sidebarPrimaryButtonBgHoverColor'] ); ?>;
		border-color: <?php echo custom_branding_sanitize_hex( $colorSelected['sidebarPrimaryButtonBgHoverColor'] ); ?>;
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['sidebarPrimaryButtonTextHoverColor'] ); ?>;
	}
	.mn-core-ui .postbox .button, 
	.mn-core-ui .postbox .button-secondary, 
	.comment-php .postbox #minor-publishing .button {
		background: <?php echo custom_branding_sanitize_hex( $colorSelected['sidebarStandardButtonBgColor'] ); ?>;
		border-color: <?php echo custom_branding_sanitize_hex( $colorSelected['sidebarStandardButtonBgColor'] ); ?>;
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['sidebarStandardButtonTextColor'] ); ?>;
	}
	...
	.mn-core-ui .postbox .button:focus, 
	.mn-core-ui .postbox .button:hover {
		background: <?php echo custom_branding_sanitize_hex( $colorSelected['sidebarStandardButtonBgHoverColor'] ); ?>;
		border-color: <?php echo custom_branding_sanitize_hex( $colorSelected['sidebarStandardButtonBgHoverColor'] ); ?>;
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['sidebarStandardButtonTextHoverColor'] ); ?>;
	}

	/* Meta Link Tabs */
	#screen-meta-links a,
	#screen-meta-links a.show-settings {
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['contentMetaTextColor'] ); ?>;
		background: <?php echo custom_branding_sanitize_hex( $colorSelected['contentMetaBgColor'] ); ?> !important;
	}
	#screen-meta-links a:hover,
	#screen-meta-links a.show-settings:hover {
		color: <?php echo custom_branding_sanitize_hex( $colorSelected['contentMetaTextHoverColor'] ); ?>;
		background: <?php echo custom_branding_sanitize_hex( $colorSelected['contentMetaBgHoverColor'] ); ?> !important;
	}
	...
	#welcome-panel,
	#mn-content-editor-tools,
	.mn-editor-expand #mn-content-editor-tools {
		border-color: <?php echo custom_branding_sanitize_hex( $colorSelected['contentDividerColor'] ); ?>;
	}
