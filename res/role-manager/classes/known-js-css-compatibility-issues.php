...
class RM_Known_JS_CSS_Compatibility_Issues {
    
    public static function fix($hook_suffix, $rm_hook_suffixes) {

        $rm_hook_suffixes[] = 'users.php';
        $rm_hook_suffixes[] = 'profile.php';
        
        if (!in_array($hook_suffix, $rm_hook_suffixes)) {
            return;
        }
    ...
    /**
     * Unload MN TechGoStore design JS and CSS to exclude compatibility issues with RM
     */
    ...
    /**
     * Unload MusicPlay design CSS to exclude compatibility issues with RM
     * 
     */
    ...
    private static function unload_conflict_plugins_css($hook_suffix) {    
        ...
        // remove conflict CSS from responsive-admin-maintenance-admn plugin
...
// end of RM_Fix_Known_JS_CSS_Compatibility_Issues