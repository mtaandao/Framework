...
Supercharge your Mtaandao theme with mega pack of shortcodes


== Description ==

[Shortcodes Ultimate](http://gndev.info/shortcodes-ultimate/) is Mtaandao plugin that provides mega pack of shortcodes. This is really premium plugin that you can get absolutely for free!
...
* [Show Me the Shortcode](http://themnchick.com/show-shortcode/) + Video
* [Shortcodes Ultimate: Ultimatize your written content](http://wisdmlabs.com/blog/how-to-style-mtaandao-themes-with-shortcodes-ultimate/)
* [Shortcodes Ultimate Plugin Review](http://kevindankowebdesign.com/shortcodes-ultimate-plugin-review/)
* [Add 4s0+ New Layout Features To Mtaandao with Shortcodes Ultimate](http://www.makeuseof.com/tag/add-40-new-layout-features-mtaandao-shortcodes-ultimate/)
* [Shortcodes Ultimate – Free Shortcode Plugin For Mtaandao](http://www.mtaandao-masterclass.com/shortcodes-ultimate-free-shortcode-plugin-for-mtaandao/)
* (Video) [Supercharge Mtaandao With A Mega Pack Of Shortcodes!](https://www.youtube.com/watch?v=h5hlJb0mSSY)
...
* (RU) [Шорткоды Wordpress](http://somemoreinfo.ru/shortkody-mtaandao-ot-anoxina/)
...
* [Support forum](http://mtaandao.co.ke/support/plugin/shortcodes-ultimate/)
...
Unzip plugin files and upload them under your '/main/plugins/' directory.

Resulted names will be:
  './main/plugins/shortcodes-ultimate/*'
...
= 4.9.8.1 =
* Fixed: compatibility with Mtaandao 4.3+
...
* Added: new attribute for [button title=""], [forum topic](https://mtaandao.co.ke/support/topic/how-add-title-tag-to-a-button)
...
* Fixed: JS error (blocking shortcodes settings) on Mtaandao 3.5
* Fixed: minor improvement for slider/gallery posts query. [Forum topic](https://mtaandao.co.ke/support/topic/slider-code-suggestion)
...
* Fixed: vulnerability in Examples preview. Added mn_nonce check. Thanks to [Kacper Szurek](http://security.szurek.pl/)
* Fixed: vulnerability at Custom CSS page. Added mn_nonce check. Thanks to [Ryan Satterfield](https://planetzuda.com/)
...
* Fixed: errors when updating user profile, [forum topic](https://mtaandao.co.ke/support/topic/error-message-when-updating-users-in-admin)
...
* Added: new option wmode for [youtube_advanced], [forum topic](http://mtaandao.co.ke/support/topic/youtube-player-option-request)
* Added: new shortcode [lightbox_content]
* Fixed: lightbox and galleries scripts, [forum topic](http://mtaandao.co.ke/support/topic/carousel-su-little-hack)
* Fixed: removed global function $.support.transition, [forum topic](http://mtaandao.co.ke/support/topic/transition-check-returns-string-instead-of-object)
...
* Fixed: animations script has been changed. CSS animations will be skipped in non-supported browsers, [forum topic](http://mtaandao.co.ke/support/topic/disable-animations-on-non-supported-devicesbrowsers)
* Fixed: templates/default-loop.php - removed extra n character in comments number, [forum topic](http://mtaandao.co.ke/support/topic/minor-bug-in-templatesdefault-loopphp)
* Fixed: large DB query on sites with many users, [forum topic](http://mtaandao.co.ke/support/topic/installing-sc-ultimate-on-site-with-30000-mn-users)
...
* Added: full compatibility with multiple editors on same page - [fourm topic](http://mtaandao.co.ke/support/topic/enhance-compatibility-with-other-plugins)
* Fixed: extra CSS class for [menu] - [forum topic](http://mtaandao.co.ke/support/topic/extra-css-class-not-working-on-menu-shortcode-video-included)
* Fixed: Swiper click event, Swiper has been updated - [forum topic](http://mtaandao.co.ke/support/topic/carousel-links-not-working)
...
* Fixed bug with multiple users queries - [forum topic](http://mtaandao.co.ke/support/topic/plugin-making-700-sql-calls)
* New Ghost style for [button]
* Minor UI fixes (for MN 3.9+)
...
* New locale - VI
* Fixed bug with tax_term IDs in [posts] shortcode, [forum topic](http://mtaandao.co.ke/support/topic/posts-tax_term-category-number)
* Fixed bug with service title, [forum topic](http://mtaandao.co.ke/support/topic/service-shortcode-not-wrapping-properly-on-mobile-browser)
* Fixed bug with animations names in shortcode generator, [forum topic](http://mtaandao.co.ke/support/topic/animations-2)
...
* New review - [Shortcodes Ultimate: Ultimatize your written content](http://wisdmlabs.com/blog/how-to-style-mtaandao-themes-with-shortcodes-ultimate/)
* New review - [Add 40+ New Layout Features To Mtaandao with Shortcodes Ultimate](http://www.makeuseof.com/tag/add-40-new-layout-features-mtaandao-shortcodes-ultimate/)
* New review - [Show Me the Shortcode](http://themnchick.com/show-shortcode/) + Video
* Updated readme.txt
* Compatibility with recent version of [SiteOrigin page builder](siteorigin.com/page-builder/) - it's free!
* Compatibility with recent version of [Visual Composer](http://vc.mtaandao.co.ke/plugins/page-builder/)
...
* New MN filters for shortcodes attributes
...
* Anchor navigation for spoilers and tabs - [forum topic](http://mtaandao.co.ke/support/topic/hyperlinks-to-spoilers-and-tabs)
* Small fixes
...
* Z-index for visual composer - [forum topic](http://mtaandao.co.ke/support/topic/compatible-with-visual-composer)
...
* Fixed warning in footer - [forum topic](http://mtaandao.co.ke/support/topic/bug-showing-in-online-site-after-updating-the-plugin)
* Removed warning at settings page - [forum topic](http://mtaandao.co.ke/support/topic/warning-on-settings-page)
* Removed another warning (undefined index) - [forum topic](http://mtaandao.co.ke/support/topic/undefined-index-with-mn_debug-true)
...
* Fixed [lightbox]
* Disabled mn_footer check
* Fixed mn_footer notice, again
* Small fix for tooltips
* Fixed mn_footer notice
* Greek translation
* Added compatibility mode prefix for spoilers inside of accordion
* Updated qTip plugin
* Added shortcode [tooltip]
* Added new attribute. [tab disabled="yes"]. Now, any tab can be disabled. [Forum topic](http://mtaandao.co.ke/support/topic/tabs-how-to-disable-one-of-the-tabs)
* Added [accordion] scrolling. [Forum topic](http://mtaandao.co.ke/support/topic/accordion-usability-issue)
* Added mn_footer check. User will be noticed if current theme doen't includes mn_footer
...
* For security maniacs: timthumb.php replaced by native Mtaandao mechanism
...
= 2.7 =
* French translation
* Fixed for work with new jQuery 1.6 in MN 3.2
