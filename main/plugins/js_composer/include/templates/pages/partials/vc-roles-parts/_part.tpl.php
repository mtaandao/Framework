		...
		<tr data-vc-role-related-part="<?php echo esc_attr( $part . '-' . $role ) ?>"
			...
			<td>
				<fieldset>
					...
					<?php endif; ?>
					<table class="vc_general vc_mn-form-table fixed" data-vc-roles="table">
						<thead>
						<tr>
		...
		<tr data-vc-role-related-part="<?php echo esc_attr( $part . '-' . $role ) ?>"
			...
			<td>
				<fieldset>
					...
					<div class="vc_mn-form-row">
						<?php foreach ( $capabilities as $cap ) : ?>
							<div class="vc_mn-form-col vc_mn-form-checkbox">
								<label>
									<input type="checkbox"
