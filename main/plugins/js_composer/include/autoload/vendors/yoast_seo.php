 ...
 */
// 16 is required to be called after MNSEO_Admin_Init constructor. @since 4.9
...
function vc_init_vendor_yoast() {
	...
	if ( is_plugin_active( 'wordpress-seo/mn-seo.php' ) || class_exists( 'MNSEO_Metabox' ) ) {
		require_once vc_path_dir( 'VENDORS_DIR', 'plugins/class-vc-vendor-yoast_seo.php' );
		$vendor = new Vc_Vendor_YoastSeo();
		if ( defined( 'MNSEO_VERSION' ) && version_compare( MNSEO_VERSION, '3.0.0' ) === - 1 ) {
