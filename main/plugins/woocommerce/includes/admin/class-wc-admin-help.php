...
class WC_Admin_Help {
	...
	public function add_tabs() {
		...
		$screen->add_help_tab( array(
			...
			'content'   =>
				...
				'<p>' . sprintf(
					...
					'<a href="https://mtaandao.co.ke/support/plugin/woocommerce">',
					'</a>',
		...
		$screen->set_help_sidebar(
			...
			'<p><a href="' . 'https://mtaandao.co.ke/extend/plugins/woocommerce/' . '" target="_blank">' . __( 'Mtaandao.org Project', 'woocommerce' ) . '</a></p>' .
