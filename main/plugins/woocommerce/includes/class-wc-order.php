...
class WC_Order extends WC_Abstract_Order {
	...
	public function get_total_refunded() {
		...
		$total = $mndb->get_var( $mndb->prepare( "
	...
	public function get_total_tax_refunded() {
		...
		$total = $mndb->get_var( $mndb->prepare( "
			...
			FROM {$mndb->prefix}woocommerce_order_itemmeta AS order_itemmeta
			INNER JOIN $mndb->posts AS posts ON ( posts.post_type = 'shop_order_refund' AND posts.post_parent = %d )
			INNER JOIN {$mndb->prefix}woocommerce_order_items AS order_items ON ( order_items.order_id = posts.ID AND order_items.order_item_type = 'tax' )
	...
	public function get_total_shipping_refunded() {
		...
		$total = $mndb->get_var( $mndb->prepare( "
			...
			FROM {$mndb->prefix}woocommerce_order_itemmeta AS order_itemmeta
			INNER JOIN $mndb->posts AS posts ON ( posts.post_type = 'shop_order_refund' AND posts.post_parent = %d )
			INNER JOIN {$mndb->prefix}woocommerce_order_items AS order_items ON ( order_items.order_id = posts.ID AND order_items.order_item_type = 'shipping' )
			WHERE order_itemmeta.order_item_id = order_items.order_item_id
