...
if ( 'nivo' === $type ) {
	...
	mn_enqueue_script( 'nivo-slider' );
	mn_enqueue_style( 'nivo-slider-css' );
	mn_enqueue_style( 'nivo-slider-theme' );
	...
	$slides_wrap_end = '</ul>';
	mn_enqueue_style( 'flexslider' );
	mn_enqueue_script( 'flexslider' );
} elseif ( 'image_grid' === $type ) {
	mn_enqueue_script( 'vc_grid-js-imagesloaded' );
	mn_enqueue_script( 'isotope' );
	mn_enqueue_style( 'isotope-css' );
