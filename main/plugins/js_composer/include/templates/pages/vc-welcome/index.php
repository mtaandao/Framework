...
<div class="wrap vc-page-welcome about-wrap">
	...
	<div class="about-text">
		<?php _e( 'Congratulations! You are about to use most powerful time saver for Mtaandao ever - page builder plugin with Frontend and Backend editors by WPBakery.', 'js_composer' ) ?>
	</div>
	<div class="mn-badge vc-page-logo">
	...
	<p class="vc-page-actions">
		...
		<a href="https://twitter.com/share" class="twitter-share-button"
			data-via="wpbakery"
			data-text="Take full control over your #Mtaandao site with Visual Composer page builder"
