...
class RWMB_Media_Field extends RWMB_File_Field {
	...
	public static function admin_enqueue_scripts() {
		mn_enqueue_media();
		mn_enqueue_style( 'rwmb-media', RWMB_CSS_URL . 'media.css', array(), RWMB_VER );
		mn_enqueue_script( 'rwmb-media', RWMB_JS_URL . 'media.js', array( 'jquery-ui-sortable', 'underscore', 'backbone', 'media-grid' ), RWMB_VER, true );
