...
( function( $, data, mn, ajaxurl ) {
	$( function() {
		...
		var rowTemplate        = mn.template( 'wc-tax-table-row' ),
			rowTemplateEmpty   = mn.template( 'wc-tax-table-row-empty' ),
			paginationTemplate = mn.template( 'wc-tax-table-pagination' ),
			$table             = $( '.wc_tax_rates' ),
			$tbody             = $( '#rates' ),
...
})( jQuery, htmlSettingsTaxLocalizeScript, mn, ajaxurl );
